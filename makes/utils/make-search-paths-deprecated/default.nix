...
in
derivations: builtins.trace "[WARNING] Make-search-paths is deprecated! do not use" makeTemplate {
  arguments = {
  ...
  name = "makes-utils-make-search-paths-deprecated";
  template = path "/makes/utils/make-search-paths-deprecated/setup-paths-template.sh";
}
