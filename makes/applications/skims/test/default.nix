...
makeEntrypoint {
  arguments = {
    ...
    envVulnerableJsAppRepo = fetchzip {
      url = "https://github.com/fluidattacks/vulnerable_js_app/archive/0f973b89e3da0d3914d5250bff4ddeb836343c2a.tar.gz";
      sha256 = "0apyp3w4yljfm1rrpx3za7pk7d893d5szi9v3xpswy77i3n2gnas";
    };
  };
  name = "skims-test";
  searchPaths = {
