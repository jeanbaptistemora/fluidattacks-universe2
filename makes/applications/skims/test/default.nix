...
makeEntrypoint {
  arguments = {
    ...
    envVulnerableJsAppRepo = fetchzip {
      url = "https://github.com/fluidattacks/vulnerable_js_app/archive/75082f3dcc276ea4e283287714073b539e87fb2c.tar.gz";
      sha256 = "1fqai8q9i62fg7cx9hsinnncs92s776155w8f0ybbqgfrbsfqv0j";
    };
  };
  name = "skims-test";
  searchPaths = {
