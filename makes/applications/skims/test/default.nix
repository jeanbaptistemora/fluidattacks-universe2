...
makeEntrypoint {
  arguments = {
    ...
    envVulnerableJsAppRepo = fetchzip {
      url = "https://github.com/fluidattacks/vulnerable_js_app/archive/54eb37758b306c7c407462d861768e03876928db.tar.gz";
      sha256 = "1lga4nzbzzmmc0f1cyydffy8bjzf2y961nb62vwkps4wbqcfq66l";
    };
  };
  name = "skims-test";
  searchPaths = {
