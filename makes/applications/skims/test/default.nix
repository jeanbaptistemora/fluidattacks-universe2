...
makeEntrypoint {
  arguments = {
    ...
    envVulnerableJsAppRepo = fetchzip {
      url = "https://github.com/fluidattacks/vulnerable_js_app/archive/2da6e13b1854af4e3fe17f3a1f8974a09225cbb7.tar.gz";
      sha256 = "0bf6gynksfcym95ka9mzf3ajsvdcyig4kb747x1043rrnw3g9axr";
    };
  };
  name = "skims-test";
  searchPaths = {
