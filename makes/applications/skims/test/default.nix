...
makeEntrypoint {
  arguments = {
    ...
    envVulnerableJsAppRepo = fetchzip {
      url = "https://github.com/fluidattacks/vulnerable_js_app/archive/6c735e2d57d958fb01b23ac211083259f4ea2296.tar.gz";
      sha256 = "06jz6zwmmw2jz35bcxb8zpbpdn6c7j29wy7jfq1ghwgs6qgsyyxv";
    };
  };
  name = "skims-test";
  searchPaths = {
