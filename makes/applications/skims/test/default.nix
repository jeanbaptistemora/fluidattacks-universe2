...
makeEntrypoint {
  arguments = {
    ...
    envVulnerableJsAppRepo = fetchzip {
      url = "https://github.com/fluidattacks/vulnerable_js_app/archive/eaea4e80ac24d5944d5d1cb962b4c5ef4d862434.tar.gz";
      sha256 = "033cx3xbpyd65df8mp2n8bzm8i59sj1x6658srz485wh1ic296wb";
    };
  };
  name = "skims-test";
  searchPaths = {
