...
makeEntrypoint {
  arguments = {
    ...
    envVulnerableJsAppRepo = fetchzip {
      url = "https://github.com/fluidattacks/vulnerable_js_app/archive/90cfb78beac4523d7a34219eea93da7a73e48431.tar.gz";
      sha256 = "1f6bn2d2rr2q2arlpkd63d8dx340byxygfb0slj88ycn0y5c8ax1";
    };
  };
  name = "skims-test";
  searchPaths = {
