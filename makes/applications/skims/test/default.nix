...
makeEntrypoint {
  arguments = {
    ...
    envVulnerableJsAppRepo = fetchzip {
      url = "https://github.com/fluidattacks/vulnerable_js_app/archive/10d781d11c0ecc147e57dec29f9bf022acae7c33.tar.gz";
      sha256 = "0nx9ayk2qv0w067ls1w518rr6zq6hlca5mxma0zij80pv32f7hgd";
    };
  };
  name = "skims-test";
  searchPaths = {
