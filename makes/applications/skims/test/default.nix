...
makeEntrypoint {
  arguments = {
    ...
    envVulnerableJsAppRepo = fetchzip {
      url = "https://github.com/fluidattacks/vulnerable_js_app/archive/45cb3a861c4a7d0ff90a4f739eb57adc3c2bacc0.tar.gz";
      sha256 = "0rsh3d18acgb65g6fx8dln087x5jhrg71zfvdp56kfz6qz6r4dpv";
    };
  };
  name = "skims-test";
  searchPaths = {
