...
makeEntrypoint {
  arguments = {
    ...
    envVulnerableJsAppRepo = fetchzip {
      url = "https://github.com/fluidattacks/vulnerable_js_app/archive/7da6f5b8ebce92565abda6b2755546e6ae56cc7a.tar.gz";
      sha256 = "16dllyg63a9v60rihnd6idk2h08jb77zzs6mjkw1ra36cnnh7z1h";
    };
  };
  name = "skims-test";
  searchPaths = {
