...
makeEntrypoint {
  arguments = {
    ...
    envVulnerableJsAppRepo = fetchzip {
      url = "https://github.com/fluidattacks/vulnerable_js_app/archive/c4bcace3ad2675f2e8ec8f35d02e853b6a957e16.tar.gz";
      sha256 = "0lsbzxbf9kfz1kdv2mvwbf23r05lpfdh71adpn4rpw7m2s8fx980";
    };
  };
  name = "skims-test";
  searchPaths = {
