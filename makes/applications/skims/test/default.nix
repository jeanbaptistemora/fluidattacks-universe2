...
makeEntrypoint {
  arguments = {
    ...
    envVulnerableJsAppRepo = fetchzip {
      url = "https://github.com/fluidattacks/vulnerable_js_app/archive/7d717c2df62250f485772f4a01c9d4c992c579b4.tar.gz";
      sha256 = "0cws7pxcskrhhsr268sdviy6yl0s98zd6zh3s8gz8q7arcy407l0";
    };
  };
  name = "skims-test";
  searchPaths = {
