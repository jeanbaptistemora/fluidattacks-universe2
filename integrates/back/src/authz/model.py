...
GROUP_LEVEL_ROLES: Dict[str, Dict[str, Set[str]]] = dict(
    admin=dict(
        actions={
            ...
            "api_mutations_reject_zero_risk_vulnerabilities_new_mutate",
            ...
            "api_mutations_request_verification_vulnerabilities_mutate",
            "api_mutations_request_verification_vulnerabilities_new_mutate",
            ...
            "api_mutations_request_zero_risk_vuln_new_mutate",
            ...
            "api_mutations_verify_request_vulnerabilities_mutate",
            "api_mutations_verify_request_vulnerabilities_new_mutate",
