...
GROUP_LEVEL_ROLES: Dict[str, Dict[str, Set[str]]] = dict(
    admin=dict(
        actions={
            ...
            "api_resolvers_group_authors_resolve",
...
GROUP_LEVEL_ROLES_FOR_FLUIDATTACKS: Dict[str, Dict[str, Set[str]]] = dict(
    ...
    vulnerability_manager=dict(
        actions={
            *GROUP_LEVEL_ROLES["vulnerability_manager"]["actions"],
            "api_resolvers_group_disambiguation_resolve",
            "api_resolvers_group_toe_inputs_resolve",
            "api_resolvers_group_toe_lines_resolve",
        },
...
ORGANIZATION_LEVEL_ROLES: Dict[str, Dict[str, Set[str]]] = dict(
    admin=dict(
        actions={
            ...
            "api_resolvers_credentials_key_resolve",
            "api_resolvers_credentials_password_resolve",
            "api_resolvers_credentials_token_resolve",
            "api_resolvers_credentials_user_resolve",
