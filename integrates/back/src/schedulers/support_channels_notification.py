...
async def send_support_channels_notification() -> None:
    ...
    for stakeholder in stakeholders:
        ...
        if (
            ...
            await mail_support_channels_notification(
                loaders, stakeholder.email
            )


async def main() -> None:
    await send_support_channels_notification()
