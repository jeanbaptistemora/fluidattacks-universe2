...
try:
    ...
    FI_ZOHO_SUBSCRIPTIONS_CLIENT_ID = os.environ[
        "ZOHO_SUBSCRIPTIONS_CLIENT_ID"
    ]
    FI_ZOHO_SUBSCRIPTIONS_CLIENT_SECRET = os.environ[
        "ZOHO_SUBSCRIPTIONS_CLIENT_SECRET"
    ]
    FI_ZOHO_SUBSCRIPTIONS_ORG_ID = os.environ["ZOHO_SUBSCRIPTIONS_ORG_ID"]
    FI_ZOHO_SUBSCRIPTIONS_REFRESH_TOKEN = os.environ[
        "ZOHO_SUBSCRIPTIONS_REFRESH_TOKEN"
    ]
