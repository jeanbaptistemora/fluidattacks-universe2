...
async def _test_forces() -> None:  # pylint: disable=too-many-statements
    ...
    assert executions[0]["vulnerabilities"] == {
        ...
        "acceptedExploits": [
            {
                "kind": "DAST",
                "who": "https://test.com/test/loooooooooooooooooooooooo"
                "ooooooooooooooooooooooooooooooooooooooooooooooooooong",
                "where": "HTTP/Implementatioooooooooooooooooooooooooooo"
                "oooooooooooooooooooooooooooooooooooooooooooooooooooooon",
            }
        ],
