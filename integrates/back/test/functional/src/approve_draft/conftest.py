...
async def populate(generic_data: dict[str, Any]) -> bool:
    data: dict[str, Any] = {
        "findings": [
            ...
            {
                "finding": Finding(
                    id="8bf3c5e8-1e90-452c-b89d-f9be9eff197b",
                    group_name="group1",
                    state=FindingState(
                        modified_by="test1@gmail.com",
                        modified_date=datetime.fromisoformat(
        ...
        "vulnerabilities": [
            ...
            },
            {
                "vulnerability": Vulnerability(
                    created_by=generic_data["global_vars"]["hacker_email"],
                    created_date=datetime.fromisoformat(
                        "2019-04-08T00:45:14+00:00"
                    ),
                    finding_id="8bf3c5e8-1e90-452c-b89d-f9be9eff197b",
                    group_name="group1",
                    hacker_email=generic_data["global_vars"]["hacker_email"],
                    id="6b1646d7-63fb-4706-b37b-0e5095746cac",
                    state=VulnerabilityState(
                        modified_by=generic_data["global_vars"][
                            "hacker_email"
                        ],
