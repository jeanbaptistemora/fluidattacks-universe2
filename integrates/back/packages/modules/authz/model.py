...
GROUP_LEVEL_ROLES: Dict[str, Dict[str, Set[str]]] = dict(
    admin=dict(
        actions={
            ...
            'backend_api_mutations_create_draft_new_mutate',
            ...
            'backend_api_mutations_update_toe_lines_sorts_mutate',
...
ORGANIZATION_LEVEL_ROLES: Dict[str, Dict[str, Set[str]]] = dict(
    admin=dict(
        actions={
            ...
            (
                'api_resolvers_query_stakeholder__'
    ...
    customeradmin=dict(
        actions={
            ...
            'api_resolvers_organization_stakeholders_resolve',
            (
                'api_resolvers_query_stakeholder_'
