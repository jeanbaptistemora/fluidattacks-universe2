...
class InvalidGroupServicesConfig(Exception):
    """Exception to control that services attached to a group are valid."""
    def __init__(self, msg: str) -> None:
        """ Constructor """
        super(InvalidGroupServicesConfig, self).__init__(
            f'Exception - {msg}')
...
class RepeatedToeInput(Exception):
    def __init__(self) -> None:
...
class ToeInputNotFound(Exception):
    def __init__(self) -> None:
