  ...
  searchFindings: {
    ...
    tabEvents: {
      ...
      affectedComponentsValues: {
        clientStation: "Estación de pruebas del Cliente",
        compileError: "Error en compilación",
        documentation: "Documentación del proyecto",
        fluidStation: "Estación de pruebas de FLUID",
        internetConnection: "Conectividad a Internet",
        localConnection: "Conectividad local (LAN, WiFi)",
        other: "Otro(s)",
        sourceCode: "Código fuente",
        testData: "Datos de prueba",
        toeAlteration: "Alteración del ToE",
        toeCredentials: "Credenciales en el ToE",
        toeExclussion: "Exclusión de alcance",
        toeLocation: "Ubicación del ToE (IP, URL)",
        toePrivileges: "Privilegios en el ToE",
        toeUnaccessible: "Inaccesibilidad del ToE",
        toeUnavailable: "Indisponibilidad del ToE",
