...
describe("groupToeLinesView", (): void => {
  ...
  it("should filter by seen at", async (): Promise<void> => {
    ...
    fireEvent.change(document.querySelectorAll(`input[name="seenAt"`)[1], {
  ...
  it("should filter by sorts risk level", async (): Promise<void> => {
    ...
    fireEvent.change(
      screen.getAllByRole("spinbutton", { name: "sortsRiskLevel" })[0],
      {
        target: { value: 79 },
      }
    );
    fireEvent.change(
      screen.getAllByRole("spinbutton", { name: "sortsRiskLevel" })[1],
      {
        target: { value: 81 },
      }
    );
  ...
  it("should filter by attacked lines", async (): Promise<void> => {
    ...
    fireEvent.change(
      screen.getAllByRole("spinbutton", { name: "attackedLines" })[1],
      {
        target: { value: 121 },
      }
    );
  ...
  it("should filter by attacked at", async (): Promise<void> => {
    ...
    fireEvent.change(document.querySelectorAll(`input[name="attackedAt"]`)[1], {
      target: { value: "2021-02-21" },
    });
  ...
  it("should filter by first attack at", async (): Promise<void> => {
    ...
    fireEvent.change(
      document.querySelectorAll(`input[name="firstAttackAt"]`)[1],
      {
        target: { value: "2020-02-20" },
      }
    );
