...
async def test_correct_assert(
    ...
    assert await get_group_data(test_group) == {
        ...
        ('F009', 'APPROVED', (
            ...
            ('test/data/lib_path/f009/java.properties', '18'),
        ...
        ('F047_AWS', 'SUBMITTED', (
            ...
            ('test/data/lib_path/f047_aws/cfn_groups_without_egress.yaml', '18'),
            ('test/data/lib_path/f047_aws/cfn_groups_without_egress.yaml.json', '26'),
