...
CHECKS: Tuple[Tuple[core_model.FindingEnum, Any], ...] = (
    ...
    (core_model.FindingEnum.F164, f164.analyze),
    ...
    (core_model.FindingEnum.F236, f236.analyze),
    ...
    (core_model.FindingEnum.F381, f381.analyze),
