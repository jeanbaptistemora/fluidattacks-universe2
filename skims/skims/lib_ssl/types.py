...
ssl_suites: Dict["str", List[int]] = {
    "DHE_RSA_WITH_CHACHA20_POLY1305_SHA256": [0xCC, 0xAA],
    ...
    "DHE_RSA_WITH_AES_128_CCM": [0xC0, 0x9E],
    "DHE_RSA_WITH_AES_256_CCM": [0xC0, 0x9F],
    ...
    "DHE_RSA_WITH_AES_128_GCM_SHA256": [0x00, 0x9E],
    "DHE_RSA_WITH_AES_256_GCM_SHA384": [0x00, 0x9F],
