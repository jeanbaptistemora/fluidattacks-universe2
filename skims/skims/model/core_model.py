...
class FindingEnum(Enum):
    ...
    F052_SSLV3: FindingMetadata = FindingMetadata.new(
        auto_approve=False,
        code="F052_SSLV3",
        cwe=326,
        execution_queue=ExecutionQueue.ssl,
    ...
    F052_TLS: FindingMetadata = FindingMetadata.new(
        auto_approve=False,
        code="F052_TLS",
        cwe=326,
        execution_queue=ExecutionQueue.ssl,
    ...
    F070_FLOAT_CURRENCY: FindingMetadata = FindingMetadata.new(
        auto_approve=False,
        code="F070_FLOAT_CURRENCY",
        cwe=197,
