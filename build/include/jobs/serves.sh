...
function job_serves_rotate_keys_user_provision_asserts_dev {
  ...
  local gitlab_key_id_name='ASSERTS_DEV_AWS_ACCESS_KEY_ID'
  local gitlab_secret_key_name='ASSERTS_DEV_AWS_SECRET_ACCESS_KEY'
...
function job_serves_rotate_keys_user_provision_asserts_prod {
  ...
  local gitlab_repo_id='20741933'
  local gitlab_key_id_name='ASSERTS_PROD_AWS_ACCESS_KEY_ID'
  local gitlab_secret_key_name='ASSERTS_PROD_AWS_SECRET_ACCESS_KEY'
  local gitlab_masked='true'
