...
:keywords: Credentials, Access, Password, Length, CWE, ASVS, PCI DSS, Rules, Ethical Hacking, Pentesting
:rules: yes
...
. [[r3]] link:https://www.pcisecuritystandards.org/documents/PCI_DSS_v3-2-1.pdf[PCI DSS v3.2.1 - Requirement 8.2.3]
