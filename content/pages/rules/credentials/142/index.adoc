...
:keywords: Change, Credentials, Default, Password, System, ASVS, Rules, Ethical Hacking, Pentesting
:rules: yes
...
. [[r5]] link:https://www.pcisecuritystandards.org/documents/PCI_DSS_v3-2es-LA.pdf[PCI DSS - Requirement 2.2.d]
