...
:keywords: Change, Credentials, Default, Password, System, ASVS, PCI DSS, Rules, Ethical Hacking, Pentesting
:rules: yes
...
. [[r6]] link:https://www.pcisecuritystandards.org/documents/PCI_DSS_v3-2-1.pdf[PCI DSS v3.2.1 - Requirement 2.2.1]
