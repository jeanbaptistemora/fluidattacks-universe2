...
:keywords: HTTP, Security, Header, Configuration, ASVS, CWE, PCI DSS, Rules, Ethical Hacking, Pentesting
:rules: yes
...
. [[r27]] link:https://www.pcisecuritystandards.org/documents/PCI_DSS_v3-2-1.pdf[PCI DSS v3.2.1 - Requirement 6.5.9]
Address common coding vulnerabilities in software-development processes such as
