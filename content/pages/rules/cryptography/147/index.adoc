...
:keywords: Cryptographic, Encryption, Mechanisms, HIPAA, NIST, ASVS, PCI DSS, Rules, Ethical Hacking, Pentesting
:rules: yes
...
. [[r13]] link:https://www.pcisecuritystandards.org/documents/PCI_DSS_v3-2-1.pdf[PCI DSS v3.2.1 - Requirement 4.1.1]
