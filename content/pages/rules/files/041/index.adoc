...
:keywords: Validate, File, Code, ASVS, CWE, Malicious, PCI DSS, Rules, Ethical Hacking, Pentesting
:rules: yes
...
. [[r5]] link:https://www.pcisecuritystandards.org/documents/PCI_DSS_v3-2-1.pdf[PCI DSS v3.2.1 - Requirement 5.1.1]
