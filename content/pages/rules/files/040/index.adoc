...
:keywords: System, Size, File, MB, ASVS, CWE, Rules, Ethical Hacking, Pentesting
:rules: yes
...
. [[r1]] link:https://cwe.mitre.org/data/definitions/434.html[CWE-434: Unrestricted Upload of File with Dangerous Type].
