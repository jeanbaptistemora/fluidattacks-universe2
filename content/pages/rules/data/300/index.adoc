...
:keywords: Requirement, Security, Data, Information, Business, Mask, GDPR, OWASP, PCI DSS, Rules, Ethical Hacking, Pentesting
:rules: yes
...
. [[r4]] link:https://www.pcisecuritystandards.org/documents/PCI_DSS_v3-2-1.pdf[PCI DSS v3.2.1 - Requirement 3.3]
