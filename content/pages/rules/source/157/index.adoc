...
:keywords: Source Code, Strict, Mode, Compilation, ASVS, CWE, PCI DSS, Interpretation, Rules, Ethical Hacking, Pentesting
:rules: yes
...
. [[r5]] link:https://owasp.org/www-project-top-ten/OWASP_Top_Ten_2017/Top_10-2017_A8-Insecure_Deserialization[OWASP Top 10 A8:2017-Insecure Deserialization].
