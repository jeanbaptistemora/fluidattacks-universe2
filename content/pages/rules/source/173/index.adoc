...
* link:/web/findings/0004/[F004. Remote command execution]

* link:/web/findings/0008/[F008. Reflected cross-site scripting (XSS)]

* link:/web/findings/0010/[F010. Stored cross-site scripting (XSS)]

* link:/web/findings/0023/[F023. Uncontrolled external site redirect]
