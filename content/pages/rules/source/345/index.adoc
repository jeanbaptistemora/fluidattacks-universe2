...
:keywords: Overflow, Buffer, Mechanism, Protection, ASVS, CWE, PCI DSS, Rules, Ethical Hacking, Pentesting
:rules: yes
...
. [[r7]] link:https://www.pcisecuritystandards.org/documents/PCI_DSS_v3-2-1.pdf[PCI DSS v3.2.1 - Requirement 6.5.2]
