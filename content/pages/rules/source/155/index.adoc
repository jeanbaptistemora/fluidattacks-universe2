...
:keywords: Source Code, Functional Requirements, ASVS, CWE, Different, Back Doors, Rules, Ethical Hacking, Pentesting
:rules: yes
...
back doors, rootkits, time bombs, logic bombs, etc.
