...
- *Standarization:*
  ...
  efforts or repo synchronization is needed.
...
==== 7.2.8 One branch per developer
...
==== 7.2.9 No dependency auto-update
...
[IAC]
==== 7.2.10 Infrastructure as code (IaC)
...
As all our infrastrucutre is descentralized,
