...
=== 9.2 All our hired personnel must accept a NDA
...
=== 9.5 Audit reports of every employee
...
=== 9.6 Everyone has a standard laptop
...
=== 9.7 Secure policies for enrolled mobile devices
...
=== 9.8 No physical keys to our offices
