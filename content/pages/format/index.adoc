...
You can use +callouts+ to explain in detail
a line within your source code.
It works similar to comments,
but does not add extra lines to your code, which is good.
...
....
 ...
 ----
 include::/web/content/pages/format/script.feature [] -> No space
 ----
....
...
[source, gherkin, linenums]
----
include::/web/content/pages/format/script.feature[]
----
...
You can use this link:https://www.planttext.com/[PlantUML Live Editor]
to see the rendered graph for your source code.
