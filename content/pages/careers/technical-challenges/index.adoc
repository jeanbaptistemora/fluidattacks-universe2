...
(`push` to the `git` training repository) within 14 calendar days.
...
in the training repository is defined in the
...
you can proceed to the [inner]#link:https://gitlab.com/autonomicmind/training/wikis/Submission[Submission guide]#
