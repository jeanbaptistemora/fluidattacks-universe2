...
link:https://gitlab.com/autonomicmind/challenges/-/merge_requests?scope=all&utf8=%E2%9C%93&state=merged&search=code[Programming],
link:https://gitlab.com/autonomicmind/challenges/-/merge_requests?scope=all&utf8=%E2%9C%93&state=merged&search=hack[Hacking]
and link:https://gitlab.com/autonomicmind/challenges/-/merge_requests?scope=all&utf8=%E2%9C%93&state=merged&search=vbd[Vulnerable by Design (`VbD`)].
...
----
https://autonomicmind.com/challenges/users/{$GITLAB_USERNAME}/
----
