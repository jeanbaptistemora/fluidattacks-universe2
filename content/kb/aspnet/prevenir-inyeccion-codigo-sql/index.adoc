:slug: kb/aspnet/prevenir-inyeccion-codigo-sql
:eth: no
:category: aspnet
:kb: yes
...
. https://www.microsoft.com/en-us/download/details.aspx?id=55984[Validar los datos proporcionados por el usuario]