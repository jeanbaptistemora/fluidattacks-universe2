...
se tienen las siguientes implicaciones <<ref1, [1]>>:
...
contenida en el objeto +StringBuilder+ en dicho momento  <<ref2, [2]>>.
+
...
. [[ref1]] https://msdn.microsoft.com/en-us/library/3457w616.aspx[Creating Reusable Elements with ASP.NET User Controls]
. [[ref2]] https://msdn.microsoft.com/es-es/library/2839d5h5(v=vs.110).aspx[Microsoft, Utilizar la clase StringBuilder]
. [[ref3]] REQ.0159: El código debe utilizar contenedores o estructuras de datos optimizadas.