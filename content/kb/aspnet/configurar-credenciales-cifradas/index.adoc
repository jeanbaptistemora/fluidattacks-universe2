...
:eth: no
:category: aspnet
:description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la configuración segura de credenciales en ASP.NET.
:keywords: ASP.NET, Credenciales.
:kb: yes
...
La herramienta +Aspnet_regiis.exe+ está ubicada en la carpeta +%WINDIR%\Microsoft.NET\Framework\versionNumber+. 
