:slug: kb/aspnet/prevenir-almacenamiento-pag-cache/
:eth: no
:category: aspnet
:kb: yes
...
la carga de los servidores y el retraso de las descargas <<ref1, [1]>>.
...
y cuya creación requiere un tiempo de procesamiento significativo <<ref2,[2]>>.
...
en el que son solicitados <<ref3, [3]>>.
...
. [[ref1]] https://es.wikipedia.org/wiki/Cach%C3%A9_(inform%C3%A1tica)[Memoria Caché]
. [[ref2]] https://msdn.microsoft.com/es-es/library/xsbfdd8c(v=vs.100).aspx[Almacenamiento en caché en ASP.NET]
. [[ref3]] https://msdn.microsoft.com/es-es/library/ms178597(v=vs.100).aspx[Información general sobre el almacenamiento en caché en ASP.NET]
. [[ref4]] http://www.esasp.net/2010/06/como-evitar-cache-de-pagina-en-el.html[Como evitar Cache de Página en el Explorador]
. [[ref5]] REQ.0172: El sistema no debe almacenar información sensible en archivos temporales o en memoria caché.