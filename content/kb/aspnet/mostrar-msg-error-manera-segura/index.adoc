:slug: kb/aspnet/mostrar-msg-error-manera-segura/
:eth: no
:category: aspnet
:kb: yes
...
que incluya el nombre del usuario que está utilizando.
...
+
* Establecer el atributo _mode_ en _RemoteOnly_ 
...
* Se recomienda también incluir un atributo _defaultRedirect_ 
que señale a una página de error personalizada de la aplicación.

* Como alternativa, incluya elementos _<error>_ 
...
. https://msdn.microsoft.com/es-es/library/994a1482(v=vs.100).aspx[Cómo: Mostrar mensajes de error seguros]

. https://www.owasp.org/index.php/Error_Handling[Error Handling]