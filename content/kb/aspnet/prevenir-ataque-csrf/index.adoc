:slug: kb/aspnet/prevenir-ataque-csrf/
:eth: no
:category: aspnet
:kb: yes
...
y no para modificar el estado  <<ref1, [1]>>.
...
en los sitios comprometidos por XSS <<ref2, [2]>> . 
...
. [[ref1]]https://msdn.microsoft.com/es-es/magazine/hh708755.aspx[Protección contra CSRF]
. [[ref2]]https://www.owasp.org/index.php/.NET_AntiXSS_Library[Librería Anti-Cross Site Scripting] 