:slug: kb/windows/deshabilitar-puerto-innecesario/
:category: windows
...
entre la localización de memoria y el canal de comunicación ^<<r1,[1]>>^. 
...
. [[r1]] link:https://es.wikipedia.org/wiki/Puerto_(inform%C3%A1tica)[Puerto (informática)]
. [[r2]] link:https://support.microsoft.com/es-co/help/813878/how-to-block-specific-network-protocols-and-ports-by-using-ipsec[Deshabilitar protocolos y puertos]