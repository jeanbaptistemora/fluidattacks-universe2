:slug: kb/criterio/requisito-seguridad-006/ 
:eth: no
:category: criterio
:kb: yes

= REQ.006 Cada amenaza sobre un activo de información debe ser medida en términos de su probabilidad de ocurrencia
