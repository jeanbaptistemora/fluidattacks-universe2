...
* Dueño, responsable o propietario del activo (https://fluid.la/web/es/kb/criterio/requisito-seguridad-002/[REQ. 002]).

* Clasificación del activo en cuanto a la confidencialidad, 
disponibilidad e integridad del mismo.

* Valor del activo teniendo en cuenta su clasificación (https://fluid.la/web/es/kb/criterio/requisito-seguridad-003/[REQ. 003]).
