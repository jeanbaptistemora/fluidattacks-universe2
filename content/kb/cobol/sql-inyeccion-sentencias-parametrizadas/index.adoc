:slug: kb/cobol/sql-inyeccion-sentencias-parametrizadas/
:category: cobol
...
:keywords: cobol, sentencias parametrizadas, sentencias estáticas, inyección sql, vulnerabilidad.
:kb: yes

= Prevenir SQL Inyección Mediante Sentencias Parametrizadas
...
. [[r1]] REQ.0168: El sistema debe descartar 
