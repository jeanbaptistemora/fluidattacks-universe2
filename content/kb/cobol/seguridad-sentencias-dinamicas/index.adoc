:slug: kb/cobol/seguridad-sentencias-dinamicas/
:category: cobol
:description: Nuestros ethical hackers explican cómo evitar vulnerabilidades de seguridad al momento de usar sentencias SQL dinámicas.
:keywords: z/OS, OS/400, sentencias dinámicas, sql, base de datos, procesador, procedimientos almacenados.
:kb: yes
