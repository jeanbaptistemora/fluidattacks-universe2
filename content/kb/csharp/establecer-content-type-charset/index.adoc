:slug: kb/csharp/establecer-content-type-charset/
:category: csharp
:description: Nuestros ethical hackers explican la manera para establecer las cabeceras content-type y charset de una aplicación desarrollada en C#.
:keywords: CSharp, Seguridad, Charset, Content-Type.
:kb: yes
