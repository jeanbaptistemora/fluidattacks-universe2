...
link:../../../en/blog/importance-pentesting/[inyecciones]
link:../../../en/blog/fuzzy-bugs-online/#comparison-with-manual-injection/[+SQL+],
link:../../../en/blog/gherkin-steroids/#dynamic-detection-and-exploitation/[recorrido de directorios],
link:../../../en/blog/xml-exploitable-markup-language/#injecting-xpath-into-a-vulnerable-app/[inyección +XPath+],
e
link:../../../en/blog/app-pickle/#documenting-attack-vectors/[inyección de comandos +UNIX+].
