...
link:../../../en/blog/protect-organization-hacker-lamer/#[injection],
...
y
link:../../../en/blog/app-pickle-document-gherkin/#documenting-attack-vectors/[+UNIX+ command injection].
...
link:../app-pickle-document-gherkin/[+str_replace+] o
link:../gherkin-steroids/[+strpos+].

Tomando algunas ideas del
link:../stand-shoulders-giants/[análisis de código estático]
y el enfoque de
link:../oracle-code/['código-como-datos']
...
tenemos que elegir un analizador.
...
En +pyparsing+ el analizador más externo
