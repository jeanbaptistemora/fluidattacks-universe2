...
.Programa de manipulación de imágenes de GNU – https://www.gimp.org/[GIMP]
image::gimp.png[gimp]
...
En otros https://fluidattacks.com/web/es/blog/arte-ocultar-informacion-imagen/[artículos] 
...
.Imagen del Reto – http://www.hacker.org/challenge/chal.php?id=88[Hacker.org]
image::reto.png[reto]
