...
link:https://goo.gl/LDcRk4[Burp Suite]. Sin embargo, en mi opinión, las principales
...
*link:https://www.hackthis.co.uk/[hackthis]*, el cual, permite validar tus
...
link:https://www.mozilla.org/en-US/firefox/new/[Firefox] ya que me siento más cómodo
...
link:https://goo.gl/hbFNXs[Google Chrome] y Microsoft Edge (el sucesor de Internet
Explorer), y, para los usuarios de mac existe link:https://goo.gl/goCaqK[Safari].
...
etiquetas *link:https://www.w3schools.com/html/[html]*, hojas de estilos en cascada
(*link:https://www.w3schools.com/css/[CSS]*-Cascading Stylesheets) y algunas veces,
