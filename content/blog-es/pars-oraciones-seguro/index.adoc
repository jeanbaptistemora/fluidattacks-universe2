...
:keywords: Ethical Hacking, Detección, Intérprete, Python, Inyección, BWAPP
...
link:../fuzzy-bugs-enlinea/#comparacion-con-la-inyeccion-manual[+SQL+],
link:../gherkin-esteroides/#deteccion-y-explotacion-dinamica[recorrido de directorios],
link:../xml-lenguaje-marcado-explotable/#inyectando-xpath-en-una-aplicacion-vulnerable[inyección +XPath+],
e
...
Ejecutar desde la raíz del servidor +PHP+ probado.
