...
link:../app-aprieto/[Anteriormente] habíamos propuesto utilizar
...
funciona en el momento del ataque.
...
Esto debe incluir, en detalle, todo lo necesario para ejecutar la aplicación.
