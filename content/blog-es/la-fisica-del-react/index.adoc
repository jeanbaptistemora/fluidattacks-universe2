...
:description: Características de una interfaz de usuario exitosa. Que es React y como integrarlo con JavaScript. Principales bondades de React. Cosas no tan buenas al usar esta librería. Aproximación a los componentes sin estado en React. Cómo implementar un enfoque funcional a la interfaz de usuario con React.
...
[button]#link:../por-que-somos-funcionales/[Por qué somos funcionales?]#
y [button]#link:../../../en/blog/functional-fashion-in-javascript/[Functional Fashion in JavaScript]#,
