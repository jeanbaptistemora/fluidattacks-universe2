...
.footnote:[Imagen tomada de link:https://www.w3.org/[W3]]
...
.Diferencia en HTTP y HTTPS footnote:[Imagen tomada de link:http://www.wordpressmagazine.es[WordPress]]
