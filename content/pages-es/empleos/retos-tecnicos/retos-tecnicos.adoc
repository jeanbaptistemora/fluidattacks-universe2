...
. Solicitarnos el permiso de acceso al repositorio vía Slack indicandonos su nombre de usuario.
...
* *Versionamiento:* Todos los archivos relacionados con la resolución de retos, se deben almacenar en este repositorio GIT en la estructura
de retos indicada.
{nbsp} +
{nbsp} +
...
Apreciaremos mucho que nos informe de sus avances mínimo 1 vez cada semana por el siguiente enlace: https://fluid.la/forms/training .
...
image::ranking_mundial_codeabbey.png[Ranking mundial]

image::ranking_colombia_codeabbey.png[Ranking Colombia]

* En Wechall (Para retos de hacking):

image::ranking_wechall.png[Ranking en Wechall]
