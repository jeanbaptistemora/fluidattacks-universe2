...
== 14. Sintaxis de commits y commitlint

En +Fluid Attacks+ utilizamos una sintaxis particular para commits y MR's,
esto con el objetivo de realizar análisis de datos.
Todos los mensajes de commit y MR
serán evaluados por el integrador continuo (CI).
Para más información sobre la sintaxis, consultar este link:https://gitlab.com/fluidattacks/default/wikis/Commit-and-MR-Messages[link].

Commitlint es una herramienta que permite verificar si un mensaje de commit o MR
es válido según las reglas sintácticas definidas.
Commitlint permite ser ejecutado localmente
con el objetivo de acelerar el proceso de validación.
Para más información sobre commitlint, visitar este link:https://gitlab.com/fluidattacks/default/wikis/Commit-and-MR-Messages#local-commitlint-setup[link].
