...
En programación, deben ser retos que:

. No tienen solución en el repositorio (carpeta del reto) para el lenguaje elegido por usted, 
. No tienen solución externa indexada (enlaces OTHERS.txt del reto) para el lenguaje elegido por usted,
. El lenguaje de la solución es uno de los aceptados por [button]#link:http://www.codeabbey.com/[Codeabbey]#.

En hacking, deben ser retos que:

. No tienen solución en Gherkin (*.feature) en el repositorio (carpeta del reto), 
. No tienen solución externa indexada (enlaces OTHERS.txt del reto),
. El lenguaje de la solución es uno de los aceptados por Codeabbey.
. Requieran nivel técnico (no matemático ni de adivinanzas) de [button]#link:wechall.net[wechall]# o sus sitios relacionados,
. (Opcionalmente) correspondan a explotación en sistemas (ToE) vulnerables intencionalmente listados en:
...
. Todos los archivos relacionados con la resolución de retos deben respetar la estructura indicada,
...
. El mensaje de +commit+ para enviar la solución de un reto en el cual previamente se tienen 17 soluciones externas y 
8 soluciones dentro del repo es el siguiente:

  solution: codeabbey, 78 (9.63)   
  - others: 8 in, 17 out, 0 total.
...
* +MR+ pendientes de aprobación: link:https://gitlab.com/autonomicmind/training/merge_requests?scope=all&utf8=%E2%9C%93&state=opened[click aquí].
* +MR+ rechazados en el pasado: link:https://gitlab.com/autonomicmind/training/merge_requests?scope=all&utf8=%E2%9C%93&state=closed[click aquí].

Ejemplos de +MR+ aceptados en el pasado:

* +MR+ ejemplares de +hacking+: link:https://gitlab.com/autonomicmind/training/merge_requests/831[Ej. 1], link:https://gitlab.com/autonomicmind/training/merge_requests/734[Ej. 2], link:https://gitlab.com/autonomicmind/training/merge_requests/703/[Ej. 3],
* +MR+ ejemplares de programación: link:https://gitlab.com/autonomicmind/training/merge_requests/773[Ej. 1], link:https://gitlab.com/autonomicmind/training/merge_requests/750[Ej. 2], link:https://gitlab.com/autonomicmind/training/merge_requests/814[Ej. 3],
