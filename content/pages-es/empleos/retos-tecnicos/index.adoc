...
. Los comandos de *compilación* y/o +linting+ utilizados y su salida deben estar como *preludio* al inicio del código.
+
.milogin.rs
...
----
. Los comandos de ejecución utilizados y su salida deben estar como *posludio* al final del código.
+
[source, rust, linenums]
----
