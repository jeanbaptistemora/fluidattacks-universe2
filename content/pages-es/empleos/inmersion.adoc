...
. Se registre como tercero en el siguiente [read-more]#https://fluid.la/forms/tercero[formulario >>]# con el RUT anexo,
...
. Debe reportar diariamente su avance mediante el siguiente [read-more]#link:https://fluid.la/forms/training[formulario >>]#
