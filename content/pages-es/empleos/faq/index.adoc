...
*¿La oferta salarial tendrá el valor que tengo como expectativa?*::
  ...
  y +Fluid Attacks+ la respeta como expectativa.
  ...
  . La capacidad de +Fluid Attacks+ de pagar
  en el tiempo los salarios de todo el equipo.

+
En este sentido, es posible que la oferta salarial que hagamos
no tenga relación con tu expectativa,
pues +Fluid Attacks+ no considera para su escala salarial la experiencia,
