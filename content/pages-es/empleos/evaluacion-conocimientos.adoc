...
. Ingresar a la siguiente [read-more]#link:https://fluid.la/courses/login/index.php[dirección web >>]#
...
. Descarga el siguiente [read-more]#link:../../files/fluidexams.zip[software de seguridad >>]# para presentar el examen.
