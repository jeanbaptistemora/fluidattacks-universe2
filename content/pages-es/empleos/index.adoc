...
Para comenzar, 
solo debes seguir las instrucciones detalladas link:../empleos/terminos/[aquí].
...
link:https://fluid.la/forms/aplicacion[aquí]
...
Para iniciar, 
solo debes seguir las instrucciones detalladas 
link:https://fluid.la/forms/periodo[aquí]
