...
. Se registre como tercero en el siguiente [button]#https://fluidattacks.com/forms/tercero[formulario >>]# con el RUT anexo,
...
. Debe reportar diariamente su avance mediante el siguiente [button]#link:https://fluidattacks.com/forms/training[formulario >>]#
