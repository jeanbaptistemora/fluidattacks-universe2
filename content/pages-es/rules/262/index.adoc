...
. +Windows+ link:../../defends/windows/configurar-actualizaciones/[Configurar Actualizaciones Automáticas].
. +Windows+ link:../../defends/windows/deshabilitar-serv-inseguro/[Deshabilitar Servicios Inseguros].
. +Windows+ link:../../defends/windows/deshabilitar-puertos/[Deshabilitar Puertos Innecesarios].
. +Red Hat+ link:../../defends/redhat/actualizar-software/[Actualizar Software en Red Hat].
