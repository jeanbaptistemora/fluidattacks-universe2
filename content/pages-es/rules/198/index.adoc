:slug: rules/198/
:category: rules
:description: En el presente documento se detallan los requerimientos de seguridad relacionados a la gestion adecuada de dispositivos foraneos de la organizacion. En este requerimiento, se recomienda que la organizacion determine qué personas pueden acceder a recursos internos.
