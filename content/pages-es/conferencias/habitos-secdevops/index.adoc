...
Si mucho lograremos ver cómo hacen una que otra prueba sobre un ambiente
exageradamente simple con el que ningún asistente se relacionará en cuanto
a su labor diaria, surgiendo otras preguntas, *¿esto en verdad funciona?*,
