...
. Se acepten en el repositorio 10 artículos publicables en el blog que cumplan la https://fluid.la/web/es/estilo/[línea editorial].
...
a la línea editorial definida https://fluid.la/web/es/estilo/[aquí].
