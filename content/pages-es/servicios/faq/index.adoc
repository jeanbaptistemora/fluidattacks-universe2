...
la configuración de los robots de
 ...
 . Los puntos 9 - 13 se repiten hasta finalizar la suscripción

*Si quiero usar Asserts dentro de mi integrador continuo*::
*¿Cuales son las condiciones técnicas que debo cumplir?*::
 Asserts corre en cualquier plataforma de integración continua que soporte
 Docker (Docker engine 18.03.1) y cuente con acceso a internet.
