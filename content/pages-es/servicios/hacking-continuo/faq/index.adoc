...
El servicio de Hacking Continuo cuenta con una plataforma de reporte e interacción llamada link:../../../productos/integrates/[FLUIDIntegrates].
...
Desde link:../../../productos/integrates/#generar-informes-tecnicos[FLUIDIntegrates] es posible
...
Para esto los desarrolladores cuentan con acceso a link:../../../productos/integrates/[FLUIDIntegrates],
...
A través de link:../../../productos/integrates/[FLUIDIntegrates] cualquier usuario con acceso al proyecto podrá solicitar la revisión de las vulnerabilidades corregidas.
...
Uno de los objetivos del servicio de Hacking Continuo en conjunto con link:../../../productos/integrates/[FLUIDIntegrates] es mantener una comunicación clara y fluida entre todos los actores del proyecto.
...
Dentro de link:../../../productos/integrates/[FLUIDIntegrates] contamos con una sección de comentarios
...
En link:../../../productos/integrates/[FLUIDIntegrates] se cuenta con la opción de tratamiento
donde se define si la vulnerabilidad va a ser remediada o asumida por el cliente.

¿En caso de asumir una vulnerabilidad, se excluye de los informes y link:../../../productos/integrates/[FLUIDIntegrates]?::
