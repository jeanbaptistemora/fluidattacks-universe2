...
:category: servicios
:description: Recopilación de preguntas y respuestas que ayudan a comprender el servicio de Hacking Continuo y cómo este puede beneficiar una organización.
:keywords: TODO
...
Usamos el estándar internacional https://www.first.org/cvss/[CVSS] para obtener una calificación cuantitativa
...
El servicio de Hacking Continuo cuenta con una plataforma de reporte e interacción llamada link:../../../productos/fluidintegrates/[FLUIDIntegrates].
...
Desde link:../../../productos/fluidintegrates/#generar-informes-tecnicos[FLUIDIntegrates] es posible
...
Para esto los desarrolladores cuentan con acceso a link:../../../productos/fluidintegrates/[FLUIDIntegrates],
...
A través de link:../../../productos/fluidintegrates/[FLUIDIntegrates] cualquier usuario con acceso al proyecto podrá solicitar la revisión de las vulnerabilidades corregidas.
...
Uno de los objetivos del servicio de Hacking Continuo en conjunto con link:../../../productos/fluidintegrates/[FLUIDIntegrates] es mantener una comunicación clara y fluida entre todos los actores del proyecto.
...
Dentro de link:../../../productos/fluidintegrates/[FLUIDIntegrates] contamos con una sección de comentarios
...
En link:../../../productos/fluidintegrates/[FLUIDIntegrates] se cuenta con la opción de tratamiento
donde se define si la vulnerabilidad va a ser remediada o asumida por el cliente.

¿En caso de asumir una vulnerabilidad, se excluye de los informes y link:../../../productos/fluidintegrates/[FLUIDIntegrates]?::
