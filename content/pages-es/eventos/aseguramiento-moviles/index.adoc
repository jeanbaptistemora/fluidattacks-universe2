:slug: eventos/aseguramiento-moviles/
:category: eventos
:description: La presente página tiene como objetivo informar a los clientes sobre el servicio de conferencias ofrecido por Fluid Attacks. La conferencia de Aseguramiento de Dispositivos Móviles, tiene por objetivo socializar los riesgos a la seguridad que trae consigo el uso de smartphones.
:keywords: Fluid Attacks, Conferencia, Seguridad, Dispositivos, Móviles, SmartPhone.
...
Socio fundador de +Fluid Attacks+.
