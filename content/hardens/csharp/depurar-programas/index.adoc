:slug: hardens/csharp/depurar-programas/
:category: csharp
:description: Nuestros ethical hackers explican como habilitar los mensajes de depuracion en un ambiente de desarrollo y para que estos puedan ser facilmente eliminados al ser desplegada la aplicacion en un ambiente productivo.
