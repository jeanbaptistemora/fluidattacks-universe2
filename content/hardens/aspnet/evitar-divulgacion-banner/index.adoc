:slug: hardens/aspnet/evitar-divulgacion-banner/
:category: aspnet
:description: Nuestros ethical hackers explican cómo evitar vulnerabilidades de seguridad mediante la programación segura en ASPNET al evitar la divulgación de información. El banner grabbing es un método de obtención de información donde el atacante puede conocer la infraestructura detrás de una aplicación.
