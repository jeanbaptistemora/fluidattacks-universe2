:slug: hardens/cobol/registrar-excepciones-opm/
:category: cobol
:description: Nuestros ethical hackers explican cómo evitar vulnerabilidades de seguridad mediante la programación segura en cobol al capturar las excepciones que se puedan presentar debido a algún error durante la ejecución del programa.
:keywords: COBOL, OPM, Excepciones, API, QPDLOGER.
:hardens: yes
...
. [[r1]] REQ.0070: El sistema debe registrar 
todos los eventos excepcionales y de seguridad 
en una o varias bitácoras.
. [[r2]] REQ.0071: El sistema debe registrar 
