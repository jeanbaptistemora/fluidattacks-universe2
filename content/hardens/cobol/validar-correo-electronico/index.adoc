:slug: hardens/cobol/validar-correo-electronico/
:category: cobol
:description: Nuestros ethical hackers explican cómo evitar vulnerabilidades de seguridad mediante la programación segura en cobol al explicar en detalle cómo se debe validar si una cuenta de correo electrónico se encuentra vinculada a un único usuario.
:keywords: validar, correo electrónico, cobol, email, dominio.
:hardens: yes
...
. [[r1]] REQ.0114: Sistemas que empleen cuentas de correo 
