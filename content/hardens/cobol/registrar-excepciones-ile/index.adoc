:slug: hardens/cobol/registrar-excepciones-ile/
:category: cobol
...
:keywords: Cobol, Seguridad, Excepciones, ILE, CBLLE, Severidad, Ocurrencia.
:hardens: yes
...
. [[r3]] REQ.0073: El sistema debe registrar 
el momento exacto de ocurrencia 
