:slug: hardens/windows/evitar-enumeracion-usuario/
:category: windows
...
https://fluidattacks.com/web/es/hardens/windows/configuracion-directivas-dominio[Modificar configuración de directivas de dominio]
+
.ruta.shell
