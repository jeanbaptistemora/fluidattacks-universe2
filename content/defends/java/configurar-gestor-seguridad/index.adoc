...
{
  permission java.io.FilePermission "/home/Fluid-Attacks/-", "read";
};
----
...
que contenga el directorio +/home/Fluid-Attacks/-+.
...
Grant codeBase "file:/home/sysadmin/-"
{
  permission java.net.SocketPermission "union.Fluid-Attacks.com:3333" , "connect , accept";
};
----

. Con este permiso se autoriza a la aplicación
para que establezca una conexión al puerto +3333+
con el equipo +union.Fluid-Attacks.com+
...
Grant codeBase "file:/home/sysadmin/-"
{
  permission java.util.PropertyPermission "Fluid-Attacks.version", "read";
};
----
+
[source, java, linenums]
