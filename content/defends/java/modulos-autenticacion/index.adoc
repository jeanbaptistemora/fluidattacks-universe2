:slug: defends/java/modulos-autenticacion/
:category: java
:description: Nuestros ethical hackers explican cómo implementar o desarrollar módulos de autenticación personalizados de manera segura, de tal forma que estos puedan cumplir con los requerimientos y políticas implementadas dentro de una organización. En esta oportunidad se utiliza la clase LoginModule.
