...
* link:https://fluidattacks.com/web/es/defends/java/definir-rol-seguridad-tomcat/[Definir Roles De Seguridad En Tomcat]
* link:https://fluidattacks.com/web/es/defends/glassfish/definir-rol-seguridad/[Definir Roles De Seguridad En Glassfish]
