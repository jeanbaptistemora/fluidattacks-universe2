:slug: defends/java/registro-eventos/
:category: java
...
En el presente artículo, se explicara la forma de realizar
la configuración del +logger+ especificando un archivo de configuración
...
Y se configura el nivel de +log+
...
para que registre en consola un evento de cualquier nivel.
+
.handler.java
...
. [[r3]] REQ.0075: El sistema debe registrar
