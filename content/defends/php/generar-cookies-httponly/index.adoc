...
. link:https://www.owasp.org/index.php/HttpOnly#Using_PHP_to_set_HttpOnly[Using PHP to set HttpOnly].
. link:https://developer.mozilla.org/es/docs/Web/HTTP/Cookies[HTTP cookies].
