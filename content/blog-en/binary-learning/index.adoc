...
link:../machine-learning-hack/[previously],
...
* Guides link:../infinite-monkey-fuzzer/[fuzzing campagins].
...
black-box link:../infinite-monkey-fuzzer[fuzzing] of binaries,
concrete link:../symbolic-execution-mortals[symbolic ("concolic") testing]
and link:../pars-orationis-secura/[static]
link:../importance-pentesting/[analysis]
link:../replaced-machines/[tools] which, while
...
we need to choose:
  ...
  . A special vulnerability detection procedure.
    ...
    link:../infinite-monkey-fuzzer/[fuzzing] of inputs.
...
They avoid building
link:../exploit-code-graph/[graph representations of code] altogether,
and instead settle on reading the
link:../reversing-mortals[disassembly of the code]
...
link:../crash-course-machine-learning/#decision-trees-and-forests[random forest],
...
link:../crash-course-machine-learning/#artificial-neural-networks-and-deep-learning[multilayer perceptron]
The dataset was divided into three disjoint sets
for training, validation and testing,
preprocessed with a combination of `n-grams` and `word2vec` encoding,
