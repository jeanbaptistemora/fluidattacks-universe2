...
in the sense that the probabilities and impact `CI`s are lower.
...
link:https://docs.scipy.org/doc/scipy/reference/interpolate.html[Inteporlation functions:]
...
.Fabricated VaR monitoring example
...
and link:./events.csv[residual risk].
