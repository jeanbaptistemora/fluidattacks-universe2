...
In the 1970s, decision theorists extend such diagrams to
...
["graphviz", "diagram-influence.png"]
----
digraph diagraminfluence {
...
(typically cost associated with a particular risk)
will happen or not,
...
So, if you had to guess on a person's age,
...
corresponding to the parameters _cn_, _ct_, _cc_, etc.
...
of the use case model, including definitions of what each term
