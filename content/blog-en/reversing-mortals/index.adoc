...
:date: 2017-04-25
:category: techniques
:subtitle: A simple but educational challenge
:tags: revert, challenge, engineering
:image: reversing-mortals.png
:alt: Yellow puzzle missing one piece, shown in red
...
link:http://yoire.com/?mo=Challenges&path=challenges/reversing[Yoire Reversing]
...
found at link:http://www.ollydbg.de/[The official Olly Dbg] website.
...
of the code.
Now all we need to do is pull out our handy link:http://www.asciitable.com/[ascii
...
link:http://yoire.com/challenges/reversing/pe/03_crackme_average.php[Yoire Crackme
Avg]
