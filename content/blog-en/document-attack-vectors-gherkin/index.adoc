:slug: document-attack-vectors-gherkin/
:date: 2018-02-08
...
[source,gherkin]
----
include::/web/content/blog-en/document-attack-vectors-gherkin/coffee-example.feature[]
----
...
[source,gherkin]
----
include::/web/content/blog-en/document-attack-vectors-gherkin/command-injection.feature[]
----
