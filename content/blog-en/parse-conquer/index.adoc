...
.Asserts script to check DES usage
[source,python]
----
...
Notice how, in the first few lines above,
...
in just _pythonic_ allows our team to write and rewrite
static code analysis tools that change as do its user's need.
...
`Asserts` include convenient functions to test for many
