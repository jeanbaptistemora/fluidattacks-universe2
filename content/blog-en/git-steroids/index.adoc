...
According to +AngularJS+' document,
...
The last big difference between +AngularJS+' syntax and ours
...
of what we think makes a commit message to look better,
or preferring rules taken from other places over +AngularJS+' ones.
