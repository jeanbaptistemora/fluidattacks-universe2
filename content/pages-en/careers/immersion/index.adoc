...
among more than 1580 candidates,
seeks to make you a part of
an intensive self-training in programming and
+hacking+ challenges funded by +FLUIDAttacks+,
called *Immersion*.
...
+FLUIDAttacks+, regardless of your progress in points and ranking,
looks to give monetary compensation for the time invested.

== 2. Objectives

. Solve 100 programming challenges.
. Solve 100 hacking challenges.
. Complete 2 training projects.
. Publish 10 articles in our blog.
...
. Even days will be dedicated to +hacking+ challenges.
. Odd days will be dedicated to programming challenges.
. Training must begin at *7:00 AM*
in +FLUIDAttacks+ office.
...
. Usually *8 to 16 cycles* are required to finish this stage.
...
. You register as a third party in this [button]#link:../../../../forms/third-party[form]#
