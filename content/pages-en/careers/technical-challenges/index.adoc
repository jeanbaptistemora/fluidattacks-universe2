...
. They must follow the template link:https://gitlab.com/autonomicmind/training/blob/master/templates/hacking-systems.feature[hacking-systems.feature]
...
must follow one of the templates link:https://gitlab.com/autonomicmind/training/blob/master/templates/commit-msg-challenges.txt[for programming and ctf-hacking challenged]
o link:https://gitlab.com/autonomicmind/training/blob/master/templates/commit-msg-systems.txt[for systems-hacking vulnerabilities].
...
the external solutions can be a combination
of +ctf-hacking+ and +systems-hacking+ solutions.
...
To do this, you can lean on the following
