...
is to perform a _robust_ link:../pars-orationis-secura/[parsing].
...
and its link:../crash-course-machine-learning/#anomaly-detection-via-k-nearest-neighbors[_k_ nearest neighbors]
...
which sounds more like a job for link:../symbolic-execution-mortals[symbolic execution]
