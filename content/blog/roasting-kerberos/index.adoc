...
Kerberos is built using secret-key cryptography
...
it can decrypt the request. The server then can verify
...
As we can see, is a valid domain user,
...
and is only a question of time before they crack the credentials.
