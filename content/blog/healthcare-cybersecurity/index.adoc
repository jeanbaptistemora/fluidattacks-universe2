...
* We are capable of [inner]#link:../../use-cases/continuous-hacking/[continuously hacking]# enterprise-level systems.
...
and information assets [inner]#link:../../use-cases/one-shot-hacking/[in one shot]#.
Again, we rely on _"smart"_ checklists.

* We automate almost everything we already know.
[inner]#link:../../asserts/[Asserts]# is the product we have to assess
