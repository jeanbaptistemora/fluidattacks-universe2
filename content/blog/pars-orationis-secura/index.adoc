...
:keywords: Attack, Detection, Parser, Python, Injection, BWAPP
...
[source,php,numbered]
----
include::/web/content/blog/pars-orationis-secura/redux-sqli-7.php[]
----
...
[source,python,numbered]
----
include::/web/content/blog/pars-orationis-secura/sqli-parser.py[]
----
