...
Let's use `mona.py` plugin to find that instruction:
...
Let's look at the next image which is the resulting location after
...
Let's update our exploit. Remember to prepend the `w00tw00t`
