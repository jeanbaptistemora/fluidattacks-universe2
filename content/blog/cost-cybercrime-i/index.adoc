...
:description: In 2012, a study called ‘Measuring the cost of cybercrime’ was presented at the Workshop on the Economics of Information Security (WEIS). Last year, an update paper was discussed at the same workshop, showcasing what has changed since. We highlight some findings.
...
How do we do it?
Check our [inner]#link:../../services/[hacking services]#,
