...
const About = [
  ...
  "about/glossary",
  {
    ...
    items: [
      ...
      "about/fluid-attacks-vs-competition/nowsecure",
      "about/fluid-attacks-vs-competition/shiftleft",
      "about/fluid-attacks-vs-competition/snyk",
    ],
  },
];
...
const Machine = [
  {
    ...
    items: [
      ...
      "machine/web/notifications",
      {
        type: "category",
        label: "Support",
        items: ["machine/web/support/live-chat"],
      },
      {
        type: "category",
        label: "News",
        items: ["machine/web/news/subscription"],
      },
      {
        type: "category",
        label: "Organizations",
        items: ["machine/web/organization/policies"],
      },
      {
        type: "category",
        label: "Groups",
        ...
        items: [
          {
            ...
            items: [
              ...
              "machine/web/vulnerabilities/management/details",
              "machine/web/vulnerabilities/management/vulnerability-assignment",
              "machine/web/vulnerabilities/management/description",
              "machine/web/vulnerabilities/management/severity",
              "machine/web/vulnerabilities/management/evidence",
              "machine/web/vulnerabilities/management/tracking",
              "machine/web/vulnerabilities/management/records",
              "machine/web/vulnerabilities/management/consulting",
  ...
  },
  {
    type: "category",
    label: "Agent",
    items: ["machine/agent/introduction", "machine/agent/installation"],
  },
  {
    type: "category",
    label: "API",
...
const Squad = [
  ...
  "squad/consulting",
  {
    type: "category",
    label: "Support",
    items: ["squad/support/talk-hacker"],
  },
