...
slug: /criteria/requirements/173
---
...
1. Use variable highlighting: If supported,
...
1. Not only user validation but also input validation:
...
1. Denial of service caused by register overload.
1. Cross-Site Scripting (*XSS*).
1. *OS* command injection.
1. *SQL* injection.
1. *LDAP* injection.
1. Redirect to untrusted pages.
...
- [CIS Controls. 18.2 Ensure That Explicit Error Checking Is Performed for All
  In-House Developed Software:](https://www.cisecurity.org/controls/)
...
- [OWASP-ASVS v4.0.1 V5.2 Sanitization and Sandboxing Requirements.(5.2.2):](https://owasp.org/www-pdf-archive/OWASP_Application_Security_Verification_Standard_4.0-en.pdf)
