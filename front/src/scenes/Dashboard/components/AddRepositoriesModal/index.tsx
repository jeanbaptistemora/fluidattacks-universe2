...
import { maxLength, required, validField, validUrlField } from "../../../../utils/validations";
            ...
            <Row>
              ...
              <Col md={7}>
                ...
                <Field
                  ...
                  type="text"
                  validate={[required, validField, maxRepoUrlLength, validUrlField]}
                />
              </Col>
            </Row>
            <Row>
              <Col md={5}>
                ...
                <Field
                  ...
                  type="text"
                  validate={[required, validField, maxRepoBranchLength, validUrlField]}
                />
              </Col>
              {index > 0 ? (
