...
import { statusGraph, treatmentGraph } from "../../../../utils/formatHelpers";
...
const indicatorsView: React.FC<IIndicatorsViewBaseProps> = (props: IIndicatorsViewBaseProps): JSX.Element => {
  ...
  const handleQryError: ((error: ApolloError) => void) = (
    ...
    graphQLErrors.forEach((error: GraphQLError): void => {
      ...
      rollbar.error("An error occurred getting indicators", error);
    });
  };
  ...
  return (
    ...
    >
      {
        ({ data }: QueryResult<IIndicatorsProps>): JSX.Element => {
