...
if [ -z $(docker ps -q -f name="$SERVICE") ]; then
  ...
  echo "Esperando que el puerto 22003 de SSH este abierto."
  until nc -z $IP 22003; do : sleep 0.2; done
  echo "Puerto SSH (22003) abierto en contenedor."
else
