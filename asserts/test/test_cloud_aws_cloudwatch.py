...
def test_no_alarm_on_config_changes_open():
    ...
    assert cloudwatch.no_alarm_on_config_changes(
...
def test_is_event_bus_exposed_open():
    ...
    assert cloudwatch.is_event_bus_exposed(
        AWS_ACCESS_KEY_ID,
...
def test_is_event_bus_exposed_closed():
    """Check if there is an exposed event bus."""
    assert not cloudwatch.is_event_bus_exposed(
        AWS_ACCESS_KEY_ID,
...
def test_no_alarm_on_org_changes_open():
    ...
    assert cloudwatch.no_alarm_on_org_changes(
        AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY
    )
...
def test_no_alarm_on_unauthorized_api_calls_open():
    """Check if there are alarms set on organization changes."""
    assert cloudwatch.no_alarm_on_unauthorized_api_calls(
        AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY
    )
...
def test_no_alarm_on_cmk_config_changes_open():
    ...
    assert cloudwatch.no_alarm_on_cmk_config_changes(
        AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY
    )
...
def test_no_alarm_on_cloudtrail_config_changes_open():
    ...
    assert cloudwatch.no_alarm_on_cloudtrail_config_changes(
        AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY
    )
...
def test_no_alarm_on_signin_fail_open():
    ...
    assert cloudwatch.no_alarm_on_signin_fail(
        AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY
    )
...
def test_no_alarm_on_ec2_instance_changes_open():
    ...
    assert cloudwatch.no_alarm_on_ec2_instance_changes(
        AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY
    )
...
def test_no_alarm_on_iam_policy_changes_open():
    ...
    assert cloudwatch.no_alarm_on_iam_policy_changes(
        AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY
    )
...
def test_no_alarm_on_gateway_changes_open():
    ...
    assert cloudwatch.no_alarm_on_gateway_changes(
        AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY
    )
...
def test_no_alarm_on_network_acl_changes_open():
    ...
    assert cloudwatch.no_alarm_on_network_acl_changes(
        AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY
    )
...
def test_no_alarm_on_root_usage_open():
    ...
    assert cloudwatch.no_alarm_on_root_usage(
        AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY
    )
...
def test_no_alarm_on_route_table_changes_open():
    ...
    assert cloudwatch.no_alarm_on_route_table_changes(
        AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY
    )
...
def test_no_alarm_on_s3_bucket_changes_open():
    ...
    assert cloudwatch.no_alarm_on_s3_bucket_changes(
        AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY
    )
...
def test_no_alarm_on_security_group_changes_open():
    ...
    assert cloudwatch.no_alarm_on_security_group_changes(
        AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY
    )
...
def test_no_alarm_on_vpc_changes_open():
    ...
    assert cloudwatch.no_alarm_on_vpc_changes(
        AWS_ACCESS_KEY_ID, AWS_SECRET_ACCESS_KEY
    )
