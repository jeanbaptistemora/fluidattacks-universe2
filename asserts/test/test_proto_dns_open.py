...
def test_has_subdomain_takeover(get_mock_ip):
    ...
    assert dns.has_subdomain_takeover(
        "engineering.fluid.la", get_mock_ip, controlled_domains_1
    ).is_open()
    assert dns.has_subdomain_takeover(
        "engineering.fluid.la", get_mock_ip, controlled_domains_2
    ).is_open()
    assert dns.has_subdomain_takeover(
        "engineering.fluid.la", get_mock_ip, controlled_domains_3
    ).is_open()
