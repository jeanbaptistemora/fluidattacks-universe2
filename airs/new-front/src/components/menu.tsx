    ...
    <NavbarList className={"roboto"} id={"navbar_list"}>
      ...
      <li className={"relative fr pv4 db-l dn"}>
        <Link
          ...
          to={`${site.siteMetadata.url}/contact-us/`}>
      ...
      <li className={"db-xl display-none relative fr mr3 pv4"}>
        <Link className={"no-underline"} to={`${site.siteMetadata.url}/blog/`}>
      ...
      <li className={"db-xl display-none relative fr mr3 pr2 pv4"}>
        <Link
          className={"no-underline"}
          to={`${site.siteMetadata.url}/resources/`}>
      ...
      <li className={"db-l dn fr mr3 pr2 pv4 solutions-index"}>
        <Link
          className={"no-underline"}
          to={`${site.siteMetadata.url}/solutions/`}>
        ...
        <NavbarSubcategory
          ...
          <Link
            className={"f-18 fw4"}
            to={`${site.siteMetadata.url}/solutions/devsecops/`}>
            {"DevSecOps"}
          </Link>
