:page-slug: format/
:page-description: Fluid Attacks uses AsciiDoc as the main extension to help candidates and personnel build their documents properly.
:page-keywords: Fluid Attacks, Format, AsciiDoc, Templates, Tutorial, Document, Blog
:variable: AsciiDoc
:category: blog
:plus: &#43
...
+
....
 == AsciiDoc Format -> Level 1 Header

 === Headers -> Level 2 Header
...
....
.Image Title
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620228838/airs/format/doge_e5vldn.webp[Doge]
....
...
....
.Video Title
video::https://res.cloudinary.com/fluid-attacks/video/upload/v1620228846/airs/format/he-man_avvqyi.mp4[He-man]
....
...
+
....
Term image:https://res.cloudinary.com/fluid-attacks/image/upload/v1620226925/airs/icons/tooltip_kf1mug.webp[alt="Tooltip icon",title="Additional information about the term"]

Term2 image:https://res.cloudinary.com/fluid-attacks/image/upload/v1620226925/airs/icons/tooltip_kf1mug.webp[alt="Tooltip icon",title="The description can have
