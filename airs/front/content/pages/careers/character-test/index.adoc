:page-slug: careers/character-test/
:category: careers
:page-description: The following page is to inform potential talents and people interested in working with us about our selection process.
:page-keywords: Fluid Attacks, Careers, Selection, Character, Test, Strengths.
