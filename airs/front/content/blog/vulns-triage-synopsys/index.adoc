:page-slug: vulns-triage-synopsys/
:page-date: 2020-04-21
:page-subtitle: BDSA and various data points for prioritization
:page-category: opinions
:page-tags: cybersecurity, vulnerability, standard, information, software, application
:page-image: https://res.cloudinary.com/fluid-attacks/image/upload/v1620331220/blog/vulns-triage-synopsys/cover_iesvfh.webp
:page-alt: Photo by Jeremy Thomas on Unsplash
:page-description: This post is based on the webinar 'Effective Vulnerability Remediation Requires More than One Data Point' by Jeff Michael and Chris Fearon from Synopsys.
:page-keywords: Cybersecurity, Vulnerability, Triage, Standard, Information, Software, Application, Ethical Hacking, Pentesting
