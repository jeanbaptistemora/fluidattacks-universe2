:page-slug: evolution-lumu/
:page-date: 2020-03-17
:page-subtitle: Lumu's tip on continuous compromise assessment
:page-category: opinions
:page-tags: cybersecurity, security-testing, pentesting, vulnerability, hacking, business
:page-image: https://res.cloudinary.com/fluid-attacks/image/upload/v1620330870/blog/evolution-lumu/cover_s2kww9.webp
:page-alt: Photo by Johannes Plenio on Unsplash
:page-description: This post is based on the information given on February 7th by Sylvester, from Lumu, in his webinar 'Cybersecurity Testing Limitations & How to Overcome Them.'
:page-keywords: Cybersecurity, Security Testing, Pentesting, Vulnerability, Hacking, Business, Ethical Hacking, Pentesting
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620330869/blog/evolution-lumu/lumu_hxgnu1.webp[lumu]
