:page-slug: cost-cybercrime-ii/
:page-date: 2020-02-19
:page-subtitle: Uber cuts $120 million after discovering ad fraud...
:page-category: attacks
:page-tags: security, risk, vulnerability, business, policies, economics
:page-image: https://res.cloudinary.com/fluid-attacks/image/upload/v1620330837/blog/cost-cybercrime-ii/cover_vnfqpv.webp
:page-alt: Photo by Jp Valery on Unsplash
:page-description: Here we conclude our review of 'Measuring the cost of cybercrime' by focusing, among other things, on ad fraud, which appears to be a bit underrated.
...
and our [inner]#link:../../solutions/[solutions]#
