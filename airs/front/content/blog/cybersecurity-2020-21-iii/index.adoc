:page-slug: cybersecurity-2020-21-iii/
...
we'll continue to see an increase in malware activity in the coming years.
...
and have the reputation of not being up to date in terms of security.
...
There, security testing must be link:../../services/continuous-hacking/[continuous]
...
We have already mentioned that attackers are
at this time
paying too much attention to the human factor
to penetrate organizations' systems.
...
We'll also have professionals in statistics, economics, cognitive science,
...
by the skills that many firms intend to confer on their testing tools.

== Conclusion

Finally, hoping that we'll see a more clear and promising future
amid link:https://www.nature.com/articles/d41586-020-02278-5[so much uncertainty],
