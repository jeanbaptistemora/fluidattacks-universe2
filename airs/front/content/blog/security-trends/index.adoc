:page-slug: security-trends/
:page-date: 2019-10-03
:page-subtitle: Cybersecurity risks in technology trends
:page-category: techniques
:page-tags: cybersecurity, business, trends
:page-image: https://res.cloudinary.com/fluid-attacks/image/upload/v1620331094/blog/security-trends/cover_v2lf0a.webp
:page-alt: Screen showing performance stats. Photo by Stephen Dawson on Unsplash: https://unsplash.com/photos/qwtCeJ5cLYs
:page-description: In this article, we discuss the main cybersecurity trends for 2019, how to keep your company secured, and how Fluid Attacks deals with these kinds of threats.
:page-keywords: Cybersecurity, Trends, Fluid Attacks, Perspective, Techniques, Attacks, Ethical Hacking, Pentesting
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331093/blog/security-trends/iot-attacks_fvrvko.webp[Main IoT Targets]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331091/blog/security-trends/aws-alarm_qu2dfx.webp[AWS misconfigurations]
...
Asserts, a product we used to offer,
detected these flaws, using the
link:/resources/doc/asserts/fluidasserts.cloud.aws.cloudtrail/[`AWS Cloudtrail module`].
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331092/blog/security-trends/verizon-findings_qc7unv.webp[alt="Verizon findings", width=500]
