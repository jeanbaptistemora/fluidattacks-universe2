:page-slug: risk-indicator-roundup/
:page-date: 2019-05-15
:page-subtitle: A matter of taste
:page-category: philosophy
:page-tags: business, ethical-hacking, risk
:page-image: https://res.cloudinary.com/fluid-attacks/image/upload/v1620331066/blog/risk-indicator-roundup/cover_azhwyk.webp
:page-alt: Choices. Photo by Nathan Dumlao on Unsplash: https://unsplash.com/photos/pMW4jzELQCw
:page-description: Here we compare risk indicators used in quantitative finance, giving their pros and cons. Most of them we have discussed earlier, but here we introduce the ALE.
:page-keywords: Risk, Probability, Choice, Measure, Quantify, Indicator, Ethical Hacking, Pentesting
...
.(t)VaR illustration
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620330968/blog/para-bellum/tvar_fg6jpf.webp[(t)VaR illustration]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331065/blog/risk-indicator-roundup/wenus_anm8lr.webp[Acronyms joke]
