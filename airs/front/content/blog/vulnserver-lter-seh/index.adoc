:page-slug: vulnserver-lter-seh/
:page-date: 2020-06-23
:page-category: attacks
:page-subtitle: Bad chars everywhere
:page-tags: osce, vulnserver, training, exploit
:page-image: https://res.cloudinary.com/fluid-attacks/image/upload/v1620331206/blog/vulnserver-lter-seh/cover_basr0i.webp
:page-alt: Photo by Kevin Ku on Unsplash
:page-description: This post will show how to exploit the Vulnserver LTER command on where we will need to bypass bad chars restrictions.
...
We'll have to use techniques we've learned on our previous posts
and include others to exploit that command successfully.
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331206/blog/vulnserver-lter-seh/crash1_yts1qc.gif[Crash]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331202/blog/vulnserver-lter-seh/crash2_kwxlzr.gif[Crash 2]

Well, it seems we're facing an SEH overwrite. Please, check
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331204/blog/vulnserver-lter-seh/pattern1_drj3ub.gif[Pattern]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331204/blog/vulnserver-lter-seh/pattern2_fqkl7b.gif[Pattern OK]

Great. If we trigger the exception handler, we will overwrite `EIP`.

image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331200/blog/vulnserver-lter-seh/eip1_fld56r.webp[Pattern OK]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331202/blog/vulnserver-lter-seh/poppopret1_fi3zbt.webp[POP POP RET]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331201/blog/vulnserver-lter-seh/badchar1_jtchqp.gif[Badchar return address]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331206/blog/vulnserver-lter-seh/ansi1_mfxlwx.webp[ANSI]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331203/blog/vulnserver-lter-seh/bytearray1_pjftsg.webp[ANSI]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331207/blog/vulnserver-lter-seh/bytearray2_xhuyku.webp[ANSI 2]
...
Now, run this updated exploit to check
how the `LTER` command treats all the chars:

image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331201/blog/vulnserver-lter-seh/check-badchars1_ubzeez.gif[Checking bad chars]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331200/blog/vulnserver-lter-seh/badchars-start_qeb2ko.webp[Bad chars start]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331205/blog/vulnserver-lter-seh/mona-cmp1_jgfekz.gif[Mona cmp]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331206/blog/vulnserver-lter-seh/ascii-poppopret1_gliml7.webp[ASCII POP/POP/RET]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331205/blog/vulnserver-lter-seh/retsuccess1_c8o1pb.gif[Return success]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331203/blog/vulnserver-lter-seh/jmp-success1_rhjvra.gif[Jump success]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331201/blog/vulnserver-lter-seh/longjump1_knhwi2.webp[Long jump]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331200/blog/vulnserver-lter-seh/failed-encoders1_wdb2n8.gif[Failed encoders]

Having a restricted 41-byte buffer,
the common alphanumeric encoders are not viable:
...
known as ADD/SUB/AND encoding. The technique is fully described
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331203/blog/vulnserver-lter-seh/align-esp1_rwmput.gif[Align ESP]

Note that all the resulting bytes are in our allowed charset. Now update our
exploit with those instructions:
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331205/blog/vulnserver-lter-seh/align-esp2_gahfhu.gif[Align ESP]
...
Then, we need to find some values that, when added, result in `909080eb`.
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331203/blog/vulnserver-lter-seh/carve-eax1_fg9xhd.gif[Carve EAX]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331202/blog/vulnserver-lter-seh/push-eax1_pqhuob.gif[Carve EAX]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331199/blog/vulnserver-lter-seh/long-jump2_m5hsrq.webp[Second long jump]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331201/blog/vulnserver-lter-seh/align-esp3_swtzxo.gif[Align ESP]

Great! We can now encode our long backward jump.
This time I will use a tool called
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331200/blog/vulnserver-lter-seh/long-jump-success1_rmm8w0.gif[Long jump success]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331206/blog/vulnserver-lter-seh/stager2_wzgle8.gif[Stager success]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331202/blog/vulnserver-lter-seh/success_vaz7jm.gif[Success]
