:page-slug: multiple-credentials-begone/
:page-date: 2017-04-28
:page-category: identity
:page-subtitle: Security issues and solutions of SSO services
:page-tags: security, credential, saml, standard
:page-image: https://res.cloudinary.com/fluid-attacks/image/upload/v1620330940/blog/multiple-credentials-begone/cover_ytxbj5.webp
:page-alt: Multiple icon accounts
:page-description: Here we explain how to use SAML, a popular SSO implementation standard for logging users into applications based on their sessions.
:page-keywords: Security, SAML, Credentials, SSO, XML, Risks, Ethical Hacking, Pentesting
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620330938/blog/multiple-credentials-begone/image2_e8atbw.webp[saml]
...
.SAML flow
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620330938/blog/multiple-credentials-begone/image1_qyrulq.webp[flow]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620330938/blog/multiple-credentials-begone/image3_at7umz.webp[structure]
...
. [[r1]] link:https://blog.netspi.com/attacking-sso-common-saml-vulnerabilities-ways-find/[Attacking SSO: Common SAML Vulnerabilities and Ways to Find Them.
Retrieved April 28, 2017].

. [[r2]] link:https://arxiv.org/ftp/arxiv/papers/1401/1401.7483.pdf[Krawczyk, P. (2012, January 01). Secure SAML validation
to prevent XML signature wrapping attacks. Retrieved April 28, 2017].
