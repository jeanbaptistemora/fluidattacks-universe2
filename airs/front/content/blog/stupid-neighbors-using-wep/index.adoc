:page-slug: stupid-neighbors-using-wep/
:page-date: 2017-04-24
:page-category: attacks
:page-subtitle: Solving Yashira WEP Security challenge
:page-tags: wep, wifi, encryption, challenge
:page-image: https://res.cloudinary.com/fluid-attacks/image/upload/v1620331104/blog/stupid-neighbors-using-wep/cover_zfucpe.webp
:page-alt: Free wifi sign
:page-description: In this article, we explain how to crack a Wired Equivalent Privacy (WEP) algorithm by analyzing its traffic.
:page-keywords: Security, WEP, Wifi, Password, Encription, Network, Ethical Hacking, Pentesting
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331102/blog/stupid-neighbors-using-wep/image1_rgy41c.webp[reto]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331103/blog/stupid-neighbors-using-wep/image2_kdn3u3.webp[aircrack]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331102/blog/stupid-neighbors-using-wep/image3_ifwlhe.webp[dictionary]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620331102/blog/stupid-neighbors-using-wep/image4_anrc8t.webp[cracking]
