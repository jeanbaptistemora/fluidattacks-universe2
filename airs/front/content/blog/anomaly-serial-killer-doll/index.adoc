:page-slug: anomaly-serial-killer-doll/
:page-date: 2018-12-05
:page-subtitle: Hunting missing checks with anomaly detection
:page-category: machine-learning
:page-tags: machine-learning, vulnerability, discovery
:page-image: https://res.cloudinary.com/fluid-attacks/image/upload/v1620330658/blog/anomaly-serial-killer-doll/cover_k3xhjm.webp
:page-alt: The actual serial killer doll
:page-description: Here we describe the system Chucky, which applies machine learning and natural language processing techniques to find missing-check related vulnerabilities.
:page-keywords: Machine Learning, Natural Language Processing, Vulnerability, Anomaly Detection, Nearest Neighbors, Missing Check, Security, Ethical Hacking, Pentesting
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620330656/blog/anomaly-serial-killer-doll/process_abczu9.webp[Overview of Chucky's process.]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620330657/blog/anomaly-serial-killer-doll/taint_u8oilr.webp[holi]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620330656/blog/anomaly-serial-killer-doll/embed_skmtja.webp[AST, normalization and embedding]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620330656/blog/anomaly-serial-killer-doll/results_zjae1t.webp[Artificial test results for Chucky]
