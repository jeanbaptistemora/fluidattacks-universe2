:page-slug: machine-learning-hack/
:page-date: 2018-11-07
:page-subtitle: Machine learning for vulnerability discovery
:page-category: machine-learning
:page-tags: machine-learning, vulnerability, discovery
:page-image: https://res.cloudinary.com/fluid-attacks/image/upload/v1620330936/blog/machine-learning-hack/cover_q6ydtc.webp
:page-alt: Can machines learn to hack?
:page-description: This post is a bird's eye view of machine learning techniques applied to vulnerability discovery in source code, reviewing papers from 2011 to 2018.
:page-keywords: Machine Learning, Vulnerability, Anomaly Detection, Pattern Recognition, Deep Learning, Security, Ethical Hacking, Pentesting
...
// also joern
A year later,
link:https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=6956589[Yamaguchi et al. (2014)]
reuse this idea of
...
link:https://ieeexplore.ieee.org/document/7424372[Pang et al. (2015)],
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620330935/blog/machine-learning-hack/correlation_bethz4.webp[XKCD on correlation]
