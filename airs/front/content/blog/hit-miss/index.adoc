:page-slug: hit-miss/
:page-date: 2019-03-19
:page-subtitle: Estimating attack probability
:page-category: philosophy
:page-tags: business, security, risk
:page-image: https://res.cloudinary.com/fluid-attacks/image/upload/v1620330919/blog/hit-miss/cover_af7fay.webp
:page-alt: Baseball hit. Photo by Chris Chow on Unsplash: https://unsplash.com/photos/BhwRQr08PcM
:page-description: Here we work based on: What is a beta distribution, and how can it help us estimate the probability of suffering an attack given the scarce information?
...
tells us that no matter what happens at the beginning,
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620330915/blog/hit-miss/law-large-numbers_ushyni.webp[Law of large numbers. Rolling average tends to true mean.]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620330915/blog/hit-miss/beta-dist_jwrisa.webp[Beta distribution with different parameters]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620330915/blog/hit-miss/coin-toss-exp_mwyq4u.webp[edls]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620330914/blog/hit-miss/obtained-beta_sngyua.webp[Beta distribution for breaches]
...
.Updated LEC
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620330914/blog/hit-miss/lec-comparison_xufbvt.webp[Updated LEC]
