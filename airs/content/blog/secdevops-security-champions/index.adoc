:page-slug: secdevops-security-champions/
:page-date: 2020-05-21
:page-subtitle: Six recommendations for SecDevOps from Carnegie Mellon
...
:page-description: Here you'll learn about Security Champions. But first, we give you five recommendations if you're considering the implementation of security in your business.
:page-keywords: Security, Champions, Devops, Secdevops, Software, Information, Web, Cloud, Ethical Hacking, Pentesting, Devsecops
