:page-slug: ceo-bugs/
:page-date: 2019-11-09
:page-subtitle: Should CEOs discuss software defects?
:page-category: philosophy
:page-tags: business, security, company
:page-image: https://res.cloudinary.com/fluid-attacks/image/upload/v1620330831/blog/ceo-bugs/cover_o47lbb.webp
:page-alt: Broken blue ceramic plate on Unsplash: https://unsplash.com/photos/WdJkXFQ4VHY
:page-description: Software quality management, including security weaknesses, has become of strategic relevance. Here we discuss an article calling for CEOs' attention to bugs.
:page-keywords: Business, CEO, Security, Bugs, Software, Information, Ethical Hacking, Pentesting
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620330830/blog/ceo-bugs/sw-eating_qrw3cd.webp[width=630, alt="Softare is eating the world"]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620330830/blog/ceo-bugs/electronic-recall_idury6.webp[Electronics related recalls from 2007 to 2016]
...
We centralize every security hole in our Attack Surface Manager (`ASM`).
And along with processes and technology,
our link:https://docs.fluidattacks.com/criteria/[*Criteria*] act as unifying chain;
...
Everything would be available at our `ASM`,
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620330830/blog/ceo-bugs/awareness-matrix_ddbvl7.webp[Bowens Matrix]
