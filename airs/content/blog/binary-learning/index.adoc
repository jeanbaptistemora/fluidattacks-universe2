:page-slug: binary-learning/
:page-date: 2019-01-25
:page-subtitle: Learning to exploit binaries
:page-category: machine-learning
:page-tags: machine-learning, vulnerability, exploit
:page-image: https://res.cloudinary.com/fluid-attacks/image/upload/v1620330672/blog/binary-learning/cover_ejwzaw.webp
:page-alt: Binary machine learning. Credits: https://unsplash.com/photos/h3sAF1cVURw
:page-description: In this article, we describe a system named VDiscover, created from the ground up to learn vulnerabilities in binary code without access to the source.
:page-keywords: Machine Learning, Vulnerability, Exploit, Dynamic Detection, Static Detection, Security, VDiscover, Ethical Hacking, Pentesting
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620330671/blog/binary-learning/vdisc_zba7nl.webp[Diagram depicting training and recall phases of VDiscover]
