:page-slug: quantitative-python/
:page-date: 2019-04-09
:page-subtitle: Risk management with Python
:page-category: philosophy
:page-tags: business, security, risk
:page-image: https://res.cloudinary.com/fluid-attacks/image/upload/v1620330978/blog/quantitative-python/cover_budpkw.webp
:page-alt: Finance simulation. Photo by M. B. M. on Unsplash: https://unsplash.com/photos/ZzOa5G8hSPI
:page-description: Learn how to implement risk management tools and ideas like the loss exceedance curve and value-at-risk in Python using numerical and data analysis ecosystem.
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620330936/blog/monetizing-vulnerabilities/loss-risks-table_rvmog1.webp[Table with input data]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620330977/blog/quantitative-python/data-imported_eadlea.webp[Imported data]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620330977/blog/quantitative-python/results-raw_ogxmab.webp[Raw Monte-Carlo results]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620330977/blog/quantitative-python/results-hist_slrq6e.webp[Histogram of results]
...
And _voilà_, we get our loss exceedance curve as we sought:

.Simple loss exceedance curve like in our [inner]#link:../monetizing-vulnerabilities/#lec-simple[Monte Carlo article]#.
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620330976/blog/quantitative-python/lec-simple_e7eipx.webp[Simple loss exceedance curve]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620330977/blog/quantitative-python/risk-curves-together_wqeb3t.webp[Risk curves together]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620330977/blog/quantitative-python/monitor-var-time_kjpsdm.webp[Evolution of daily VaR in month]
