:page-slug: learning-code/
:page-date: 2019-08-16
:page-subtitle: A chat with Ricardo Yepes. Part 2
:page-category: interview
:page-tags: devops, training, security
:page-image: https://res.cloudinary.com/fluid-attacks/image/upload/v1620330932/blog/learning-code/cover_xsymsp.webp
:page-alt: Bookshelf with some books
:page-description: In this post, the second part of our interview with Ricardo Yepes, we address topics such as cybersecurity, academic research, a learning platform, and more.
:page-keywords: Interview, DevOps, Security, Best Practices, Philosophy, Training, Ethical Hacking, Pentesting
...
like asserts and link:https://docs.fluidattacks.com/criteria/[*Criteria*].
