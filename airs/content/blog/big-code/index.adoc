:page-slug: big-code/
:page-date: 2019-08-02
:page-subtitle: Learning from open source
:page-category: machine-learning
:page-tags: machine-learning, vulnerability, code
:page-image: https://res.cloudinary.com/fluid-attacks/image/upload/v1620330671/blog/big-code/cover_gbuzvj.webp
:page-alt: Git. Photo by Yancy Min on Unsplash: https://unsplash.com/photos/842ofHC6MaI/
:page-description: Here we'll see how DeepCode works. It has a lot of potential for identifying bugs in your code by learning from the abundant sources available in Github.
:page-keywords: Machine Learning, Vulnerability, Open Source, Deep Learning, Lint, Bug, DeepCode, Github, Ethical Hacking, Pentesting
...
.Taint analysis diagram via link:https://www.csa.iisc.ac.in/~vg/teaching/E0-256/slides/TaintAnalysis.pdf[Coseinc].
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620330670/blog/big-code/taint-analysis_fz03sg.webp[Taint analysis diagram]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620330670/blog/big-code/che-dashboard_chqwbk.webp[Dashboard for Eclipse Che]
...
.Zero issues in DSVW.
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620330669/blog/big-code/dsvw-dashboard_nhzja3.webp[Dashboard for DSVW]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620330669/blog/big-code/integrates_rlof4p.webp[Integrates Dashboard]
...
image:https://res.cloudinary.com/fluid-attacks/image/upload/v1620330669/blog/big-code/reports.py_nubki3.webp[Command Injection in Integrates?]
...
.Asserts Dashboard
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620330669/blog/big-code/asserts_vtzc8h.webp[Asserts Dashboard]

In link:https://fluidattacks.gitlab.io/asserts/[`Asserts`], however, the 15 issues
found by `DeepCode` are less worrisome, for two reasons:

* link:https://fluidattacks.gitlab.io/asserts/[`Asserts`] is not a client-server application,
but an `API` that runs locally.

* Most of the 15 issues are several instances of `SSRF`,
when
link:https://fluidattacks.gitlab.io/asserts/[`Asserts`]
makes `HTTP` requests via
