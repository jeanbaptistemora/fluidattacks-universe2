:page-slug: reverse-engineering/
:page-date: 2020-03-11
:page-subtitle: General ideas about Software Reverse Engineering
:page-category: techniques
:page-tags: revert, software, engineering, security, vulnerability, hacking
:page-image: https://res.cloudinary.com/fluid-attacks/image/upload/v1620331058/blog/reverse-engineering/cover_nsktcf.webp
:page-alt: Photo by Erda Estremera on Unsplash
:page-description: Here we review some basic concepts of reverse engineering within information technology and through what tools it can be used for ethical and malicious hacking.
:page-keywords: Revert, Software, Reverse Engineering, Security, Vulnerability, Hacking, Ethical Hacking, Pentesting
