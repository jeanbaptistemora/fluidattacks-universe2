...
=== <<delivery-sensitive-data, 5.2 Secure delivery of sensitive data>>

Here is what we do to reduce information leakage
when delivering data to the client.

[[secure-sharing]]
==== <<secure-sharing, 5.2.1 Secure information sharing system>>
...
[[protected-reports]]
==== <<protected-reports, 5.2.3 Passphrase protected reports>>
...
[[watermarked-reports]]
==== <<watermarked-reports, 5.2.4 Watermarked reports>>
...
[[unsubscribe-email]]
=== <<unsubscribe-email, 5.3 Unsubscribe email>>
