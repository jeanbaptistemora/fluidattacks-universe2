:slug: format/
:description: Fluid Attacks uses AsciiDoc as the main extension to help candidates and personnel build their documents properly.
:keywords: Fluid Attacks, Format, AsciiDoc, Templates, Tutorial, Document, Blog
:variable: AsciiDoc
:category: blog
:plus: &#43
