:slug: products/rules/findings/076/
...
. [[r2]] [inner]#link:/products/rules/list/031/[R031. Discard user session data]#

. [[r3]] [inner]#link:/products/rules/list/141/[R141. Force re-authentication]#
