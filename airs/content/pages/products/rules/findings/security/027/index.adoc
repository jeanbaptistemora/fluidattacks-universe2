:slug: products/rules/findings/027/
...
. [[r1]] [inner]#link:/products/rules/list/040/[R040. Validate file format and extension]#

. [[r2]] [inner]#link:/products/rules/list/041/[R041. Scan files for malicious code]#
