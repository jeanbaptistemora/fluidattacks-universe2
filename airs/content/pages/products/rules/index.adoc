...
. [inner]#link:../../products/rules/list#session[Session]#: Rules regarding the management of session and session information.
...
. [inner]#link:../../products/rules/list#social[Social]#: Rules regarding the usage of social networks and publicly
accessible websites.
