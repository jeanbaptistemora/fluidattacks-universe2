...
. [[r2]] link:http://capec.mitre.org/data/definitions/240.html[CAPEC-240: Resource Injection].
...
. [[r3]] link:http://capec.mitre.org/data/definitions/242.html[CAPEC-242: Code Injection].
...
. [[r4]] link:https://cwe.mitre.org/data/definitions/507.html[CWE-507: Trojan Horse].
...
. [[r5]] link:https://www.iso.org/obp/ui/#iso:std:54534:en[ISO 27001:2013. Annex A - 12.6.1]
...
. [[r18]] link:https://www.pcisecuritystandards.org/documents/PCI_DSS_v3-2-1.pdf[PCI DSS v3.2.1 - Requirement 5.2]
Ensure that all anti-virus mechanisms are kept current.

. [[r19]] link:https://www.pcisecuritystandards.org/documents/PCI_DSS_v3-2-1.pdf[PCI DSS v3.2.1 - Requirement 6.2]
