...
:keywords: Subresource, Integrity, External, Hosting, ASVS, CAPEC, CWE, Rules, Ethical Hacking, Pentesting
:rules: yes
...
. [[r4]] link:https://cwe.mitre.org/data/definitions/353.html[CWE-353: Missing Support for Integrity Check]
...
. [[r5]] link:https://cwe.mitre.org/data/definitions/494.html[CWE-494: Download of Code Without Integrity Check]
