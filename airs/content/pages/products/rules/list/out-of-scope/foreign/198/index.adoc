:slug: products/rules/list/198/
:category: foreign
:description: This requirement establishes the importance of defining what kind of people are allowed to use foreign devices in the facilities.
:keywords: Requirement, Security, Foreign, Devices, People, Authorization, Rules, Ethical Hacking, Pentesting
:rules: yes
:extended: yes
