:slug: products/rules/list/103/
:category: authorization
:description: This requirement establishes the importance of defining processes to manage access cards for authorized workforce members.
:keywords: Requirement, Security, Physical Access, Cards, Policies, Process, Rules, Ethical Hacking, Pentesting
:rules: yes
:extended: yes
