:slug: products/rules/list/109/
:category: authorization
:description: This requirement establishes the importance of monitoring restricted areas to protect the information assets stored there.
:keywords: Requirement, Security, Access Control, Monitor, Restricted Area, Physical Access, Rules, Ethical Hacking, Pentesting
:rules: yes
:extended: yes
