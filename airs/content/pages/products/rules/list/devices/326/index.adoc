:slug: products/rules/list/326/
:category: devices
:description: This requirement establishes the importance of checking whether a device on which mobile applications will run has been rooted.
:keywords: Detection, Root, Device, Rooting, Mobile Device, CWE, Rules, Ethical Hacking, Pentesting
:rules: yes
...
Mobile applications must check
whether the device on which they will run is rooted.
...
* [inner]#link:/products/rules/findings/048/[F048. Lack of root detection]#
