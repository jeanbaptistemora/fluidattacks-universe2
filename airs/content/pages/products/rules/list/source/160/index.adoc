...
. [[r10]] link:https://cwe.mitre.org/data/definitions/79.html[CWE-79: Cross-site Scripting].
...
. [[r12]] link:https://cwe.mitre.org/data/definitions/117.html[CWE-117: Improper Output Neutralization for Logs].
