...
. [[r2]] link:http://capec.mitre.org/data/definitions/242.html[CAPEC-242: Code Injection].
...
. [[r14]] link:https://www.pcisecuritystandards.org/documents/PCI_DSS_v3-2-1.pdf[PCI DSS v3.2.1 - Requirement 6.5.7]
Address common coding vulnerabilities in software-development processes such as
