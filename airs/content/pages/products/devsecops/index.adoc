:slug: products/devsecops/
:description: Pipeline Agent allows you to have DevSecOps in your company and breaks the build every time it is necessary to force the remediation of unaccepted vulnerabilities.
:keywords: Fluid Attacks, Products, Forces, Ethical Hacking, Pentesting, Security, DevSecOps
:template: products/devsecops
