:page-slug: products/defends/windows/cambiar-credenciales/
:category: windows
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad en Windows 7 al cambiar las credenciales predeterminadas del sistema. Es altamente recomendable modificar las configuraciones iniciales del sistema para evitar ataques que utilizan credenciales predeterminadas.
:page-keywords: Windows 7, Credenciales, Predeterminadas, Renombrar, Usuarios, Buenas Prácticas
:defends: yes
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620240025/airs/products/defends/windows/cambiar-credenciales/config_dilecr.webp["Editor de directivas de grupo local"]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620240024/airs/products/defends/windows/cambiar-credenciales/rename-guest_lwqhki.webp["Modificación de usuario invitado"]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620240024/airs/products/defends/windows/cambiar-credenciales/rename-admin_dfmawh.webp["Modificación de usuario administrador"]
