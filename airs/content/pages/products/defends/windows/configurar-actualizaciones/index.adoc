:page-slug: products/defends/windows/configurar-actualizaciones/
:category: windows
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la configuracion segura de Windows. En este instructivo, explicaremos paso a paso cómo actualizar y mantener versiones estables del sistema operativo en Windows Server 2008.
:page-keywords: Seguridad, Buenas Prácticas, Windows, Windows Server 2008, Actualizaciones, Automáticas.
:defends: yes
...
+
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620240178/airs/products/defends/windows/configurar-actualizaciones/controlpanel_icnmu3.webp[controlpanel]

. Después, se da clic
sobre la opción +Check for updates+(buscar actualizaciones).
+
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620240178/airs/products/defends/windows/configurar-actualizaciones/updates_w0fugz.webp[updates]
...
+
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620240178/airs/products/defends/windows/configurar-actualizaciones/install_hrbhnw.webp[install-updates]
...
+
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620240178/airs/products/defends/windows/configurar-actualizaciones/configurar_h0uyka.webp[configuracion]
