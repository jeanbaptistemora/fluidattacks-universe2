:page-slug: products/defends/windows/deshabilitar-puertos/
:category: windows
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la configuracion segura de Windows. En este instructivo, explicaremos paso a paso cómo deshabilitar puertos innecesarios en un sistema operativo Windows evitando que se filtre malware utilizando dichos puertos.
:page-keywords: Windows, Seguridad, Puertos, Deshabilitar, Buenas Prácticas, Innecesario.
:defends: yes
...
+
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620240306/airs/products/defends/windows/deshabilitar-puertos/servicios_y3pcbg.webp[servicios]
