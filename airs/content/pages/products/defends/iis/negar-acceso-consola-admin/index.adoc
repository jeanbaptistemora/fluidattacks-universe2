:page-slug: products/defends/iis/negar-acceso-consola-admin/
:category: iis
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la configuracion segura en IIS 7.5 al negar acceso a la consola de administración. Las configuraciones del servidor no deben ser visualizadas ni accedidas por usuarios no autorizados.
:page-keywords: IIS 7.5, Consola, Administración, Acceso, Configuración, Dirección IP
:defends: yes
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620234096/airs/products/defends/iis/negar-acceso-consola-admin/addrule_p5rphh.webp["Adición de dirección IP"]

.Visualización de la nueva regla.
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620234096/airs/products/defends/iis/negar-acceso-consola-admin/restriction_nfzz8g.webp["Visualización nueva regla"]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620234096/airs/products/defends/iis/negar-acceso-consola-admin/addrule2_iyimfd.webp["Adición de IP y máscara de subred"]

.Actualización de la nueva regla.
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620234096/airs/products/defends/iis/negar-acceso-consola-admin/restriction2_ezqz9l.webp["Actualización nueva regla"]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620234096/airs/products/defends/iis/negar-acceso-consola-admin/console_buvhy8.webp["Consola de administración"]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620234096/airs/products/defends/iis/negar-acceso-consola-admin/browser_og7isx.webp["Denegación de acceso"]
