:page-slug: products/defends/hacking/evitar-ataque-dos/
:category: hacking
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la configuracion segura de sistemas para evitar un ataque de denegación de servicios (DoS). Un ataque DoS produce que un recurso sea inaccesible al generar una sobrecarga de información en el servidor.
:page-keywords: Hacking, DOS, Denegación de servicio, Ataque , Buenas Prácticas, Servidor.
:defends: yes
