:page-slug: products/defends/python/ofuscar-codigo-fuente/
:category: python
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la programacion segura en Phyton al ocultar el código fuente. La ofuscación del código dificulta que los atacantes puedan encontrar y explotar vulnerabilidades basándose en el funcionamiento de la aplicación.
:page-keywords: Python, Ofuscar, Código, Seguridad, Buenas Prácticas, Ocultar.
:defends: yes
...
----
+
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620237611/airs/products/defends/python/ofuscar-codigo-fuente/comando_tfskqu.webp[ejecucion comando Python]

. Se procede a verificar que el nuevo archivo generado esta +ofuscado+.
+
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620237611/airs/products/defends/python/ofuscar-codigo-fuente/ofuscado_lqlwns.webp[codigo ofuscado]

. Se verifica que el nuevo archivo generado
funcione exactamente igual que el original.
+
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620237611/airs/products/defends/python/ofuscar-codigo-fuente/ejecucion_u2ugen.webp[ejecucion normal]
