:page-slug: products/defends/aspnet/prevenir-ataque-csrf/
:category: aspnet
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la programacion segura en ASPNET al prevenir los ataques CSRF. La falsificación de peticiones en una página web puede causar graves daños debido a que explotan la confianza de la página en un usuario legítimo.
:page-keywords: ASPNET, Seguridad, CSRF, Cross Site Request Forgery, Petición, Buenas Prácticas.
:defends: yes
