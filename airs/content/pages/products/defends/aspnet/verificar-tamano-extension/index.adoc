:page-slug: products/defends/aspnet/verificar-tamano-extension/
:category: aspnet
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la programacion segura en ASP.NET al verificar la extensión y el tamaño de los archivos. Para evitar brechas de seguridad es importante realizar validaciones adicionales en los archivos antes de subirlos.
:page-keywords: ASP.NET, Seguridad, Validación, Extensión, Tamaño, Archivos
:defends: yes
