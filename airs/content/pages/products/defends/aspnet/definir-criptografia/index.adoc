:page-slug: products/defends/aspnet/definir-criptografia/
:category: aspnet
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la programacion segura en ASP.NET. En este artículo mostraremos cómo configurar adecuadamente los proveedores y clases criptográficas de la aplicación, estableciendo algoritmos de cifrado seguros.
:page-keywords: ASP.NET, Seguridad, Clases, Algoritmos, Cifrado, Proveedores
:defends: yes
