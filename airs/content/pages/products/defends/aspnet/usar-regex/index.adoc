:page-slug: products/defends/aspnet/usar-regex/
:category: aspnet
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la programacion segura en ASP.NET al validar las entradas de la aplicación utilizando expresiones regulares. Las entradas no validadas son vulnerables a ataques de inyección de código como XSS o SQLi.
:page-keywords: ASP.NET, Regex, Expresiones Regulares, Validación, Entrada, Seguridad.
:defends: yes
