:page-slug: products/defends/linux/limitar-sesiones-concurrente/
:category: linux
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la configuracion segura en Linux al limitar el número de sesiones concurrentes. Los atacantes pueden establecer un gran número de sesiones concurrentes para efectuar un ataque de denegación de servicio.
:page-keywords: Linux, Evitar, Sesiones, Concurrentes, Seguridad, Buenas Prácticas.
:defends: yes
