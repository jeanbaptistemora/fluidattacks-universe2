:page-slug: products/defends/cobol/cifrar-codigo-fuente/
:category: cobol
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la programacion segura en COBOL al cifrar el codigo fuente de la aplicacion. El codigo fuente contiene informacion del funcionamiento de la aplicacion y le permite a los atacantes identificar vulnerabilidades.
:page-keywords: Cobol, RPG, Seguridad, Cifrar, Código Fuente, Producción.
:defends: yes
