:page-slug: products/defends/cobol/evitar-msg-autenticacion/
:category: cobol
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la programacion segura en COBOL al evitar emitir mensajes de error en autenticación. Los mensajes de error pueden contener información que puede ser aprovechada por un atacante para vulnerar la aplicación.
:page-keywords: Cobol, Seguridad, Evitar, Autenticación, Error, Mensajes.
:defends: yes
