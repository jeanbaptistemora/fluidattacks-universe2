:page-slug: products/defends/cobol/generar-numeros-aleatorios/
:category: cobol
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la programacion segura en COBOL al generar números aleatorias. Los números aleatorios son muy utilizados en aplicaciones criptográficas y contribuyen a mejorar la seguridad general de la aplicacion.
:page-keywords: Cobol, Seguridad, Generar, Números, Aleatorios, Semilla.
:defends: yes
