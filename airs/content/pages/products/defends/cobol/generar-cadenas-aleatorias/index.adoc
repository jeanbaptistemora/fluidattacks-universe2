:page-slug: products/defends/cobol/generar-cadenas-aleatorias/
:category: cobol
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la programacion segura en COBOL al generar cadenas aleatorias. Los elementos aleatorios son muy utilizados en aplicaciones criptográficas y contribuyen a mejorar la seguridad general de la aplicacion.
:page-keywords: Cobol, Seguridad, Generar, Cadenas, Aleatorias, Números.
:defends: yes
