:page-slug: products/defends/cobol/usar-opciones-depuracion/
:category: cobol
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la programacion segura en COBOL al explicar en detalle como deben realizarse adecuadamente operaciones de depuración en etapa de desarrollo permitiendo un despliegue transparente de la misma en producción.
:page-keywords: COBOL, Debug, Desarrollo, Producción, Aplicación, Depuración.
:defends: yes
