:slug: products/defends/cobol/validar-datos-variables/
:category: cobol
:description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la programacion segura en COBOL al explicar en detalle cómo se deben validar adecuadamente los diferentes tipos de datos ingresados por el usuario, los cuales pueden provocar un mal funcionamiento del sistema.
