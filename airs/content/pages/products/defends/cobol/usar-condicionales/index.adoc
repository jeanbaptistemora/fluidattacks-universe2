:page-slug: products/defends/cobol/usar-condicionales/
:category: cobol
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la programacion segura en COBOL al contemplar todos los escenarios posibles en una estructura condicional que pueda dar origen a comportamientos erróneos dentro de la aplicación.
:page-keywords: COBOL, Variables, Condicionales, Inicializar, IF, ELSE.
:defends: yes
