:page-slug: products/defends/cobol/compilar-programa-estricta/
:category: cobol
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la programacion segura en COBOL al compilar de forma estricta el programa. Los mensajes de compilacion dejan entrever rutas e información que puede ser utilizada para vulnerar una aplicación web.
:page-keywords: Cobol, Programación, Seguridad, Compilación Estricta, Depurar, Buenas prácticas.
:defends: yes
