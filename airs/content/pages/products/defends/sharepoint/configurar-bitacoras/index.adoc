:page-slug: products/defends/sharepoint/configurar-bitacoras/
:category: sharepoint
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la programacion segura en Microsoft SharePoint 2010 al configurar el registro en bitácoras. Las bitácoras facilitan el seguimiento y detección de anomalías al registrar eventos relevantes.
:page-keywords: Sharepoint 2010, Bitácoras, Registro, Eventos, Writetrace, Seguimiento
:defends: yes
