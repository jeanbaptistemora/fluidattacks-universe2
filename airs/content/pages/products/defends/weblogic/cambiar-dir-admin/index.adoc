:page-slug: products/defends/weblogic/cambiar-dir-admin/
:category: weblogic
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la programacion segura en WebLogic 11g al cambiar la ruta predeterminada de la consola de administración. Las configuraciones por defecto no deben mantenerse debido a que suponen una vulnerabilidad para sistema.
:page-keywords: WebLogic 11g, Servidor, Oracle, Dirección, Administración, Consola.
:defends: yes
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620239664/airs/products/defends/weblogic/cambiar-dir-admin/procedure_oej0de.webp["Ruta de accesso de contexto de la consola."]
