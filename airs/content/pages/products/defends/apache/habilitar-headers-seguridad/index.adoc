:page-slug: products/defends/apache/habilitar-headers-seguridad/
:category: apache
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la configuracion segura en Apache habilitando los headers de seguridad. Los headers proporcionan información del cliente y/o servidor, además de proporcionar protección contra ataques comúnes, como los XSS.
:page-keywords: Apache, Seguridad, Headers, Configuración, XSS, Cabeceras.
:defends: yes
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620229767/airs/products/defends/apache/habilitar-headers-seguridad/headers_qlshhi.webp[headers]
