:page-slug: products/defends/apache/configurar-soporte-https/
:category: apache
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la configuracion segura en Apache de Canales seguros para el envío de información. Los canales seguros de información cifran los datos con SSL, lo que permite mejorar la seguridad de la aplicación.
:page-keywords: Apache, Seguridad, Configuración, HTTPS, SSL, TLS.
:defends: yes
