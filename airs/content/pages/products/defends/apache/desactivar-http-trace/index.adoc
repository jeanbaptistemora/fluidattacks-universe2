:page-slug: products/defends/apache/desactivar-http-trace/
:category: apache
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la configuracion segura en Apache al desactivar el método HTTP Trace. Un atacante puede aprovecharse de éste método para realizar un ataque de tipo cross site scripting (XSS).
:page-keywords: Apache, Seguridad, HTTP Trace, Servidor, XSS, Aplicación.
:defends: yes
