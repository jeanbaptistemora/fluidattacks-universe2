:page-slug: products/defends/oracle/cambiar-puerto-default/
:category: oracle
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la configuracion segura en Oracle 11g al cambiar el puerto predeterminado. Las configuraciones predeterminadas usualmente son conocidas y si se mantienen suponen una vulnerabilidad potencial para el sistema.
:page-keywords: Oracle 11g, Cambiar, Puerto, Determinado, Configuración, Seguridad.
:defends: yes
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620237461/airs/products/defends/oracle/cambiar-puerto-default/step1_jidpxe.webp["Acceso al Net Configuration Assistant de Oracle 11g."]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620237461/airs/products/defends/oracle/cambiar-puerto-default/step2_n5glp1.webp["Ventana de Listener de Oracle 11g."]
+
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620237461/airs/products/defends/oracle/cambiar-puerto-default/step3_ojpsg8.webp["Configuración del Listener de Oracle 11g."]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620237461/airs/products/defends/oracle/cambiar-puerto-default/step4_mna90b.webp["Selección de protocolo de comunicación."]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620237461/airs/products/defends/oracle/cambiar-puerto-default/step5_w7147x.webp["Selección de puerto."]
+
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620237461/airs/products/defends/oracle/cambiar-puerto-default/step6_qgxijf.webp["Configuración de puerto terminada exitosamente."]
