:page-slug: products/defends/programacion/crear-bitacoras-cond/
:category: programacion
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la programacion segura al generar bitácoras condicionales. Las bitácoras permiten registrar eventos relevantes facilitando el seguimiento de la información afectada en caso de un ataque informático.
:page-keywords: Programación, Bitácoras, Condicionales, Registro, Seguridad, Eventos.
:defends: yes
