:page-slug: products/defends/yii/usar-recaptcha/
:category: yii
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la programacion segura en PHP con el framework Yii al implementar recaptcha. Para evitar ataques de bots a la aplicación se recomienda el uso de CAPTCHAs para validar la identidad del usuario.
:page-keywords: Yii, PHP, CAPTCHA, Validación, Formularios, Humano.
:defends: yes
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620241756/airs/products/defends/yii/usar-recaptcha/captcha_drub0z.webp["reCAPTCHA implementado"]
