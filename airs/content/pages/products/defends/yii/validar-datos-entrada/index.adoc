:page-slug: products/defends/yii/validar-datos-entrada/
:category: yii
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la programacion segura en PHP utilizando el framework Yii. Las aplicaciones deben validar los datos de entrada para evitar el ingreso de código malicioso, como es el caso de ataques XSS, SQLi, CSRF, entre otros.
:page-keywords: PHP, Yii, Validar, Datos, Entrada, Código malicioso
:defends: yes
