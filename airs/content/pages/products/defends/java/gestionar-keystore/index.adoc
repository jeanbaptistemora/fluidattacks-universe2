:page-slug: products/defends/java/gestionar-keystore/
:category: java
:page-description: Nuestros ethical hackers explican que son los certificados digitales y por que es importante usarlos, para mantener la autenticidad de la información, en las operaciones cliente-servidor. Además, enseñan a gestionar de manera sencilla un Keystore usando la herramienta Keytool de Java.
:page-keywords: Java, Seguridad, Certificado, Digital, Keystore, Keytool.
:defends: yes
