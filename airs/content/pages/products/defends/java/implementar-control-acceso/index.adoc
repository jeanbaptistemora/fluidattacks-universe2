:page-slug: products/defends/java/implementar-control-acceso/
:category: java
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la programacion segura en Java al implementar un control de acceso discrecional. De esta manera es posible especificar para cada uno de los recursos los sujetos que pueden acceder a él.
:page-keywords: Java, Seguridad, Control de Acceso, Discrecional, Recursos, Permisos.
:defends: yes
