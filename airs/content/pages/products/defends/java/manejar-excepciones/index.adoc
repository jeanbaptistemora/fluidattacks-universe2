:page-slug: products/defends/java/manejar-excepciones/
:category: java
:page-description: Nuestros ethical hackers explican qué son las excepciones, cuál es su causa y que implicaciones tiene no tener un adecuado manejo de éstas, por lo tanto explican cuáles son las pautas que los desarrolladores deben tener en cuenta para un manejo seguro de las mismas.
:page-keywords: Java, Seguridad, Excepciones, Error, Programación, Prácticas.
:defends: yes
