:page-slug: products/defends/java/validar-correo-electronico/
:category: java
:page-description: Nuestros ethical hackers explican la importancia de validar los campos de entrada de datos en los formularios de aplicaciones web. Además, enseñan la manera de validar los correos electrónicos usando expresiones regulares mediante un ejemplo realizado en Java.
:page-keywords: Java, Validar, Formulario, Regex, Email, HTML.
:defends: yes
...
. [[r4]] link:../../../products/rules/list/121/[REQ.121 Garantizar unicidad de correos]
