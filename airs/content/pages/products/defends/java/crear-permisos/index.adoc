:page-slug: products/defends/java/crear-permisos/
:category: java
:page-description: Nuestros ethical hackers explican que son los permisos y la importancia de estos a la hora de controlar y proteger la información. Además, mediante un ejemplo realizado en Java, enseñan la manera de crear permisos personalizados para las diferentes aplicaciones.
:page-keywords: Java, Seguridad, Permisos, Personalizado, BasicPermission, Acceso.
:defends: yes
