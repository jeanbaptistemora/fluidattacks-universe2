:page-slug: products/defends/java/generar-id-aleatorio/
:category: java
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la programacion segura en Java al generar números aleatorios como identificadores. Los números aleatorios seguros deben tener un valor semilla no predecible, ésto se logra con la clase SecureRandom.
:page-keywords: Java, Seguridad, Número, Aleatorio, Identificador, Buenas prácticas.
:defends: yes
