:slug: products/defends/java/autenticar-servidor-cliente/
:category: java
:description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la configuracion segura en Java al autenticar el servidor para clientes sin un certificado digital. Esto resulta util cuando no es práctico o implementable la generación de certificados en el lado del cliente.
