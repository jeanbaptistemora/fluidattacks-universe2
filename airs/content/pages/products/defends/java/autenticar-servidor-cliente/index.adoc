:page-slug: products/defends/java/autenticar-servidor-cliente/
:category: java
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la configuracion segura en Java al autenticar el servidor para clientes sin un certificado digital. Esto resulta util cuando no es práctico o implementable la generación de certificados en el lado del cliente.
:page-keywords: Java, Seguridad, Autenticar, Servidor, Cliente, Certificado.
:defends: yes
...
. [[r5]] link:../../../products/rules/list/088/[REQ.088 Requerir certificados de cliente]
