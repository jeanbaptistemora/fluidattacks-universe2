:page-slug: products/defends/java/utilizar-concurrencia-ejb/
:category: java
...
:page-keywords: Java, Seguridad, EJB, Weblogic, JavaBeans, Concurrencia.
:defends: yes
...
+
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620237122/airs/products/defends/java/utilizar-concurrencia-ejb/ejb_inisqw.webp[estructura del proyecto]
...
+
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620237122/airs/products/defends/java/utilizar-concurrencia-ejb/estructura_ydboey.webp[estructura del proyecto]
