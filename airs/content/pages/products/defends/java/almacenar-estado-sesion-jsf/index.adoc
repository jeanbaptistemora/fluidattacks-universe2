:page-slug: products/defends/java/almacenar-estado-sesion-jsf/
:category: java
...
:page-keywords: Java, Seguridad, Estado , Sesión, Estándar empresarial, Javaserver Faces.
:defends: yes
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620234603/airs/products/defends/java/almacenar-estado-sesion-jsf/sesion_tzs7dt.webp[uso variables de sesion]
