:page-slug: products/defends/java/prevenir-hpp/
:category: java
:page-description: Nuestros ethical hackers explican en que consiste el ataque HTTP Parameter Pollution (HPP) y cuales son las posibles consecuencias que se pueden sufrir al ser vulnerable a dicho ataque. Por último muestran dos manera de prevenir o solventar dicho ataque.
:page-keywords: Java, Seguridad, HPP, Ataque, Validación, Inyección.
:defends: yes
