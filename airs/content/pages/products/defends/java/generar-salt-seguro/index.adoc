:page-slug: products/defends/java/generar-salt-seguro/
:category: java
:page-description: Nuestros ethical hackers nos explican que son los salts y cual es su importancia a la hora de cifrar la información confidencial de una aplicación por lo que recomiendan que, a la hora de generar un salt este debe crearse de la manera más segura posible.
:page-keywords: Java, Seguridad, Salt, Cifrado, SecureRandom, Criptografía.
:defends: yes
