:page-slug: products/defends/php/filtrar-entradas-regex/
:category: php
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la programacion segura en PHP, verificando y limpiando las entradas del sistema con ayuda de expresiones regulares, para evitar posibles explotaciones de XSS (Cross-site scripting).
:page-keywords: Php, Seguridad, Regex, Sanitize, XSS, Web.
:defends: yes
