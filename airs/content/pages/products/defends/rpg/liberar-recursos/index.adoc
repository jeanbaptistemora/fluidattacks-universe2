:page-slug: products/defends/rpg/liberar-recursos/
:category: rpg
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la liberación correcta de recursos dentro de un programa desarrollado en RPG, evitando así que información disponible en memoria pueda ser capturada por usuarios no autorizados.
:page-keywords: RPG, Recursos, Memoria, Liberar, Seguridad, Tiempo De Vida.
:defends: yes
