:page-slug: products/defends/glassfish/configurar-bitacoras/
:category: glassfish
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la programacion segura en GlassFish al configurar bitácoras. Las aplicaciones deben registrar los eventos importantes, facilitando la detección y el rastreo de ataques y situaciones no deseadas.
:page-keywords: GlassFish, Bitácora, Registro, Eventos, Aplicación, Seguimiento
:defends: yes
