:page-slug: products/defends/glassfish/definir-rol-seguridad/
:category: glassfish
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la configuracion segura en Glassfish al definir roles de seguridad. En las aplicaciones en general es necesario establecer los permisos de los usuarios para evitar posibles ataques o fugas de información.
:page-keywords: Glassfish, Definir, Roles, Seguridad, Usuarios, GPL.
:defends: yes
...
+
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620233710/airs/products/defends/glassfish/definir-rol-seguridad/nodo_bc53cl.webp[muestra nodo a acceder]

. Seleccionamos la opción de +Manage Users+, y luego +New user+.
+
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620233710/airs/products/defends/glassfish/definir-rol-seguridad/opcion_byogbg.webp[manage users]

. Creamos un usuario nuevo.

== Referencias

. [[r1]] link:../../../products/rules/list/176/[REQ.176 Restringir objetos del sistema].
