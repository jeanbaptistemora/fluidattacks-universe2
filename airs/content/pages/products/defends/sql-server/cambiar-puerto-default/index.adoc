:page-slug: products/defends/sql-server/cambiar-puerto-default/
:category: sqlserver
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la configuracion segura en Microsoft SQL Server 2008 al cambiar el puerto predeterminado. Las configuraciones predeterminadas usualmente son conocidas y  suponen una vulnerabilidad potencial para el sistema.
:page-keywords: SQL Server 2008, Cambiar, Puerto, Determinado, Configuración, Seguridad.
:defends: yes
...
+
.SQL Server Configuration Manager
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620238893/airs/products/defends/sql-server/cambiar-puerto-default/config-manager_i5gorl.webp["SQL Server Configuration Manager"]
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620238893/airs/products/defends/sql-server/cambiar-puerto-default/properties_dyu26h.webp["Propiedades TCP/IP"]
+
