:page-slug: products/defends/csharp/proteger-aplicacion-xss/
:category: csharp
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la programacion segura en C Sharp al proteger nuestra aplicación contra ataques de tipo cross site scripting. Éste es un tipo común de ataque que consiste en inyectar scripts en las entradas de la aplicación.
:page-keywords: C Sharp, Seguridad, Desarrollo, Depuración, Protección, Buenas Prácticas.
:defends: yes
