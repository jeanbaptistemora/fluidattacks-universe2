:page-slug: products/defends/csharp/evitar-codigo-duplicado/
:category: csharp
:page-description: Nuestros ethical hackers explican como evitar caer en la mala practica de programación que consiste el código fuente duplicado, en los desarrollos utilizando la centralización del manejo de excepciones como ejemplo de la reutilización de código.
:page-keywords: C Sharp, Buenas Prácticas, Código, Duplicado, Excepciones, Depuración.
:defends: yes
