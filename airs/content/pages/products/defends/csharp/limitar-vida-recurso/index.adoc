:page-slug: products/defends/csharp/limitar-vida-recurso/
:category: csharp
...
:page-keywords: C sharp, Información sensible, Información confidencial, Memoria, Búfer, Lectura segura.
:defends: yes
