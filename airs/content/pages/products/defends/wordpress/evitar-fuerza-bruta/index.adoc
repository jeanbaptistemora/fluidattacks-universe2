:page-slug: products/defends/wordpress/evitar-fuerza-bruta/
:category: wordpress
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la programacion segura en WordPress al evitar los ataques de diccionario o fuerza bruta. Los ataques de fuerza bruta pueden resultar en un robo de credenciales si la aplicación no está debidamente configurada.
:page-keywords: WordPress, Seguridad, Protección, Ataque, Diccionario, Fuerza Bruta.
:defends: yes
...
image::https://res.cloudinary.com/fluid-attacks/image/upload/v1620241649/airs/products/defends/wordpress/evitar-fuerza-bruta/login-protection_udntsx.webp["Protección contra ataques de fuerza bruta"]
