:page-slug: products/defends/scala/obtener-rutas-canon/
:category: scala
:page-description: Nuestros ethical hackers explican como evitar vulnerabilidades de seguridad mediante la programacion segura en Scala al obtener rutas absolutas canónicas. A través de este mecanismo es posible proteger a la aplicación de ataques de directorio transversal.
:page-keywords: Scala, Ruta Absoluta, Directorio, Transversal, Validación, Ruta Canónica
:defends: yes
