:page-slug: advisories/morrison/
:page-authors: Andres Roldan
:page-writer: aroldan
:page-codename: morrison
:page-product: Squid Cache
:page-date: 2021-02-16 14:00 COT
:page-cveid: Pending
:page-description: Squid Cache vulnerability
:page-keywords: Fluid Attacks, Security, Vulnerabilities, Squid
...
|*Rule* |link:https://docs.fluidattacks.com/criteria/source/345[345. Establish protections against overflows]
|*Remote*|No
...
As the value of `RAX` is populated using the malicious input configuration,
arbitrary command execution is achieved at `0x555555af55e7`.
...
* 2021-02-10: Vendor replied asking to test for the vulnerability 
