:slug: rules/219/
:category: rules
:description: En el presente documento se detallan los requerimientos de seguridad relacionados a la gestion adecuada de hipervisores en máquinas virtuales. Por lo tanto, en este requerimiento se recomienda asegurar que el manejo de hipervisores se lleve a través de un software central de gestión.
