               ...
               function getTipueSearch(start, replace)
               {
                    ...
                    if (d.length >= set.minimumLength)
                    {
                         ...
                         if (c != 0)
                         {
                              ...
                              if (show_replace)
                              {
                                   out += '<div id="tipue-search-warning">' + tipuesearch_string_2 + ' ' + d + '. ' + tipuesearch_string_3 + ' <a id="tipue-search-replaced">' + d_r + '</a></div>';
                              }
                              if (c == 1)
                              {
                              ...
                              for (var i = 0; i < found.length; i++)
                              {
                                   ...
                                   {                                   
                                        out += '<div class="tipue-search-content-title"><a href="' + found[i].url + '"' + tipue_search_w + '>' +  found[i].title + '</a></div>';
                                        ...
                                        if (set.showURL)
                                        {
                                             ...
                                             out += '<div class="tipue-search-content-url"><a href="' + found[i].url + '"' + tipue_search_w + '>' + s_u + '</a></div>';
                                        }
                                        ...
                                        {                                        
                                             ...
                                             else if (set.highlightTerms)
                                             {
                                                  ...
                                                  t = t.replace(patr, "<span class=\"tipue-search-content-bold\">$1</span>");
                                             }
                                             ...
                                             t_d = t_d.replace(/h0011/g, 'span class=\"tipue-search-content-bold\"');
                                             t_d = t_d.replace(/h0012/g, '/span');
                                             
                                             out += '<div class="tipue-search-content-text">' + t_d + '</div>';
                                        }
                                   }
                                   l_o++;     
                              }
                              ...
                              if (c > set.show)
                              {
                                   ...
                                   out += '<nav><div id="tipue_search_foot"><ul class="tipue-search-foot-boxes" id="tipue-search-foot-boxes">';
                                   
                                   if (start > 0)
                                   {
                                       out += '<li role="navigation"><a class="tipue-search-foot-box" accesskey="b" id="' + (start - set.show) + '_' + replace + '">' + tipuesearch_string_6 + '</a></li>'; 
                                   }
                                   ...
                                   if (page <= 2)
                                   {
                                        ...
                                        for (var f = 0; f < p_b; f++)
                                        {
                                             ...
                                             {
                                                  out += '<li role="navigation"><a class="tipue-search-foot-box" id="' + (f * set.show) + '_' + replace + '">' + (f + 1) + '</a></li>';
                                             }
                                        }
                                   }
                                   else
                                   ...
                                   if (page + 1 != pages)
                                   {
                                       out += '<li role="navigation"><a class="tipue-search-foot-box" accesskey="m" id="' + (start + set.show) + '_' + replace + '">' + tipuesearch_string_7 + '</a></li>'; 
                                   }                    
                         ...
                         {
                              out += '<div id="tipue-search-warning">' + tipuesearch_string_8 + '</div>'; 
                         }
                    }
                    else
                    {
                         if (show_stop)
                         {
                              out += '<div id="tipue-search-warning">' + tipuesearch_string_8 + '. ' + tipuesearch_string_9 + '</div>';     
                         }
                         else
                         {
                              out += '<div id="tipue-search-warning">' + tipuesearch_string_10 + '</div>';
                              if (set.minimumLength == 1)
                              {
                                   out += '<div id="tipue-search-warning">' + tipuesearch_string_11 + '</div>';
                              }
                              else
                              {
                                   out += '<div id="tipue-search-warning">' + tipuesearch_string_12 + ' ' + set.minimumLength + ' ' + tipuesearch_string_13 + '</div>';
                              }
                         }
                    }                
                    ...
                    $('#tipue-search-replaced').click(function()
                    {
                    ...
                    $('.tipue-search-foot-box').click(function()
                    {
