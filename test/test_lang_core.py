...
def test_unkown_has_text():
    """Test code has text."""
    assert core.has_text(NO_CODE, 'strcpy').is_unknown()


def test_unkown_has_not_text():
    """Test code does not have text."""
